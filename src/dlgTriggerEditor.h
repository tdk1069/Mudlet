...
class dlgTriggerEditor : public QMainWindow, private Ui::trigger_editor
{
  ...
  private:
    ...
    void setAllSearchData(QTreeWidgetItem *pItem, const EditorViewType &type, const QString &name, const int &id,
                          const SearchDataResultType &what, const int &pos = 0, const int &instance = 0,
    ...
    void setAllSearchData(QTreeWidgetItem *pItem, const QString &name, const QStringList &id,
                          const SearchDataResultType &what, const int &pos = 0, const int &subInstance = 0)
    {
        // Which is it? A Trigger, an alias etc:
