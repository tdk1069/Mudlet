...
const QMap<Qt::MouseButton, QString> TLuaInterpreter::mMouseButtons = {
    {Qt::NoButton, QStringLiteral("NoButton")},           {Qt::LeftButton, QStringLiteral("LeftButton")},
    {Qt::RightButton, QStringLiteral("RightButton")},     {Qt::MidButton, QStringLiteral("MidButton")},
    {Qt::BackButton, QStringLiteral("BackButton")},       {Qt::ForwardButton, QStringLiteral("ForwardButton")},
    {Qt::TaskButton, QStringLiteral("TaskButton")},       {Qt::ExtraButton4, QStringLiteral("ExtraButton4")},
    {Qt::ExtraButton5, QStringLiteral("ExtraButton5")},   {Qt::ExtraButton6, QStringLiteral("ExtraButton6")},
    {Qt::ExtraButton7, QStringLiteral("ExtraButton7")},   {Qt::ExtraButton8, QStringLiteral("ExtraButton8")},
    {Qt::ExtraButton9, QStringLiteral("ExtraButton9")},   {Qt::ExtraButton10, QStringLiteral("ExtraButton10")},
    {Qt::ExtraButton11, QStringLiteral("ExtraButton11")}, {Qt::ExtraButton12, QStringLiteral("ExtraButton12")},
    {Qt::ExtraButton13, QStringLiteral("ExtraButton13")}, {Qt::ExtraButton14, QStringLiteral("ExtraButton14")},
    {Qt::ExtraButton15, QStringLiteral("ExtraButton15")}, {Qt::ExtraButton16, QStringLiteral("ExtraButton16")},
    {Qt::ExtraButton17, QStringLiteral("ExtraButton17")}, {Qt::ExtraButton18, QStringLiteral("ExtraButton18")},
    {Qt::ExtraButton19, QStringLiteral("ExtraButton19")}, {Qt::ExtraButton20, QStringLiteral("ExtraButton20")},
    {Qt::ExtraButton21, QStringLiteral("ExtraButton21")}, {Qt::ExtraButton22, QStringLiteral("ExtraButton22")},
    {Qt::ExtraButton23, QStringLiteral("ExtraButton23")}, {Qt::ExtraButton24, QStringLiteral("ExtraButton24")},
...
TLuaInterpreter::TLuaInterpreter(Host *pH, const QString &hostName, int id)
    : mpHost(pH), hostName(hostName), mHostID(id), purgeTimer(this)
{
    pGlobalLua = nullptr;
...
QString TLuaInterpreter::dirToString(lua_State *L, int position)
{
    ...
    else if (lua_isstring(L, position))
    {
        ...
        if (!direction.compare(QLatin1String("n"), Qt::CaseInsensitive) ||
            !direction.compare(QLatin1String("north"), Qt::CaseInsensitive))
        {
            return QLatin1String("n");
        }
        else if (!direction.compare(QLatin1String("e"), Qt::CaseInsensitive) ||
                 !direction.compare(QLatin1String("east"), Qt::CaseInsensitive))
        {
            return QLatin1String("e");
        }
        else if (!direction.compare(QLatin1String("s"), Qt::CaseInsensitive) ||
                 !direction.compare(QLatin1String("south"), Qt::CaseInsensitive))
        {
            return QLatin1String("s");
        }
        else if (!direction.compare(QLatin1String("w"), Qt::CaseInsensitive) ||
                 !direction.compare(QLatin1String("west"), Qt::CaseInsensitive))
        {
            return QLatin1String("w");
        }
        else if (!direction.compare(QLatin1String("u"), Qt::CaseInsensitive) ||
                 !direction.compare(QLatin1String("up"), Qt::CaseInsensitive))
        {
            return QLatin1String("up");
        }
        else if (!direction.compare(QLatin1String("d"), Qt::CaseInsensitive) ||
                 !direction.compare(QLatin1String("down"), Qt::CaseInsensitive))
        {
            return QLatin1String("down");
        }
        else if (!direction.compare(QLatin1String("ne"), Qt::CaseInsensitive) ||
                 !direction.compare(QLatin1String("northeast"), Qt::CaseInsensitive) ||
                 !direction.compare(QLatin1String("north-east"), Qt::CaseInsensitive))
        {
            return QLatin1String("ne");
        }
        else if (!direction.compare(QLatin1String("se"), Qt::CaseInsensitive) ||
                 !direction.compare(QLatin1String("southeast"), Qt::CaseInsensitive) ||
                 !direction.compare(QLatin1String("south-east"), Qt::CaseInsensitive))
        {
            return QLatin1String("se");
        }
        else if (!direction.compare(QLatin1String("sw"), Qt::CaseInsensitive) ||
                 !direction.compare(QLatin1String("southwest"), Qt::CaseInsensitive) ||
                 !direction.compare(QLatin1String("south-west"), Qt::CaseInsensitive))
        {
            return QLatin1String("sw");
        }
        else if (!direction.compare(QLatin1String("nw"), Qt::CaseInsensitive) ||
                 !direction.compare(QLatin1String("northwest"), Qt::CaseInsensitive) ||
                 !direction.compare(QLatin1String("north-west"), Qt::CaseInsensitive))
        {
            return QLatin1String("nw");
        }
        else if (!direction.compare(QLatin1String("i"), Qt::CaseInsensitive) ||
                 !direction.compare(QLatin1String("in"), Qt::CaseInsensitive))
        {
            return QLatin1String("in");
        }
        else if (!direction.compare(QLatin1String("o"), Qt::CaseInsensitive) ||
                 !direction.compare(QLatin1String("out"), Qt::CaseInsensitive))
        {
...
int TLuaInterpreter::raiseEvent(lua_State *L)
{
    ...
    for (int i = 0; i < event.mArgumentList.size(); i++)
    {
        if (event.mArgumentTypeList.at(i) == ARGUMENT_TYPE_TABLE ||
            event.mArgumentTypeList.at(i) == ARGUMENT_TYPE_FUNCTION)
...
int TLuaInterpreter::selectString(lua_State *L)
{
    ...
    if (lua_gettop(L) > 2)
    {
        if (!lua_isstring(L, s))
        {
            lua_pushfstring(
                L,
                R"(selectString: bad argument #%d type (window name as string, is optional {defaults to "main" if omitted}, got %s!))",
                s, luaL_typename(L, s));
            lua_error(L);
            return 1;
        }
    ...
    if (!lua_isstring(L, s))
    {
        lua_pushfstring(L, "selectString: bad argument #%d type (text to select as string expected, got %s!)", s,
                        luaL_typename(L, s));
        lua_error(L);
        return 1;
    }
    ...
    {
        lua_pushfstring(L,
                        "selectString: bad argument #%d type (match count as number {1 for first} expected, got %s!)",
                        s, luaL_typename(L, s));
        lua_error(L);
        return 1;
    }
...
int TLuaInterpreter::selectCurrentLine(lua_State *L)
{
    ...
    else
    {
        if (!lua_isstring(L, 1))
        {
            lua_pushfstring(L, "selectCurrentLine: bad argument #1 type (window name as string expected, got %s!)",
                            luaL_typename(L, 1));
            return lua_error(L);
        }
        else
...
int TLuaInterpreter::isAnsiFgColor(lua_State *L)
{
    ...
    if (!lua_isnumber(L, 1))
    {
        lua_pushfstring(L, "isAnsiFgColor: bad argument #1 type (window name as string expected, got %s!)",
                        luaL_typename(L, 1));
        return lua_error(L);
    }
    else
...
int TLuaInterpreter::isAnsiBgColor(lua_State *L)
{
    ...
    if (!lua_isnumber(L, 1))
    {
        lua_pushfstring(L, "isAnsiBgColor: bad argument #1 type (window name as string expected, got %s!)",
                        luaL_typename(L, 1));
        return lua_error(L);
    }
    else
...
int TLuaInterpreter::getFgColor(lua_State *L)
{
    ...
    if (lua_gettop(L) > 0)
    {
        if (lua_isstring(L, 1))
        {
            lua_pushfstring(L, "getFgColor: bad argument #1 type (window name as string is optional, got %s!)",
                            luaL_typename(L, 1));
            return lua_error(L);
        }
        else
...
int TLuaInterpreter::getBgColor(lua_State *L)
{
    ...
    if (lua_gettop(L) > 0)
    {
        if (lua_isstring(L, 1))
        {
            lua_pushfstring(L, "getBgColor: bad argument #1 type (window name as string is optional, got %s!)",
                            luaL_typename(L, 1));
            return lua_error(L);
        }
        else
...
int TLuaInterpreter::getTextFormat(lua_State *L)
{
    ...
    if (lua_gettop(L))
    {
        if (!lua_isstring(L, 1))
        {
            lua_pushfstring(L, "getTextFormat: bad argument #1 type (window name as string is optional, got %s!)",
                            luaL_typename(L, 1));
            return lua_error(L);
        }
        windowName = lua_tostring(L, 1);
...
int TLuaInterpreter::wrapLine(lua_State *L)
{
    ...
    if (lua_gettop(L))
    {
        if (!lua_isstring(L, s))
        {
            lua_pushfstring(L, "wrapLine: bad argument #%d type (window name as string expected, got %s!)", s,
                            luaL_typename(L, 1));
            return lua_error(L);
        }
        else
    ...
    if (!lua_isnumber(L, s))
    {
        lua_pushfstring(L, "wrapLine: bad argument #%d type (line as number expected, got %s!)", s,
                        luaL_typename(L, s));
        return lua_error(L);
    }
    else
...
int TLuaInterpreter::selectCaptureGroup(lua_State *L)
{
    ...
    if (!lua_isnumber(L, 1))
    {
        lua_pushfstring(L, "selectCaptureGroup: bad argument #1 type (capture group as number expected, got %s!)",
                        luaL_typename(L, 1));
        return lua_error(L);
    }
    else
...
int TLuaInterpreter::getLines(lua_State *L)
{
    ...
    if (n > 2)
    {
        ...
        {
            lua_pushfstring(L,
                            "getLines: bad argument #%d type (mini console, user window or buffer name as string "
                            "expected {may be omitted for the \"main\" console}, got %s!)",
                            s, luaL_typename(L, s));
            return lua_error(L);
        }
        else
    ...
    if (!lua_isnumber(L, ++s))
    {
        lua_pushfstring(L, "getLines: bad argument #%d type (start line as number expected, got %s!)", s,
                        luaL_typename(L, s));
        return lua_error(L);
    }
    else
    ...
    if (!lua_isnumber(L, ++s))
    {
        lua_pushfstring(L, "getLines: bad argument #%d type (end line as number expected, got %s!)", s,
                        luaL_typename(L, s));
        return lua_error(L);
    }
    else
...
int TLuaInterpreter::loadRawFile(lua_State *L)
{
    ...
    {
        lua_pushfstring(L,
                        "loadRawFile: bad argument #1 type (replay file name, {may include a relative to \n"
...
int TLuaInterpreter::getCurrentLine(lua_State *L)
{
    ...
    else
    {
        if (!lua_isstring(L, 1))
        {
            lua_pushfstring(L, "getCurrentLine: bad argument #1 type (window name as string expected, got %s!)",
                            luaL_typename(L, 1));
            return lua_error(L);
        }
        else
...
int TLuaInterpreter::setMiniConsoleFontSize(lua_State *L)
{
    ...
    {
        lua_pushfstring(L,
                        "setMiniConsoleFontSize: bad argument #1 type (miniconsole name as string expected, got %s!)",
                        luaL_typename(L, 1));
        return lua_error(L);
    }
    else
    ...
    if (!lua_isnumber(L, 2))
    {
        lua_pushfstring(L, "setMiniConsoleFontSize: bad argument #2 type (font size as number expected, got %s!)",
                        luaL_typename(L, 2));
        return lua_error(L);
    }
    else
...
int TLuaInterpreter::getLineNumber(lua_State *L)
{
    ...
    { // Have more than one argument so first must be a console name
        if (!lua_isstring(L, ++s))
        {
            lua_pushfstring(L, "getLineNumber: bad argument #%d type (window name as string expected, got %s!)", s,
                            luaL_typename(L, s));
            return lua_error(L);
        }
        else
...
int TLuaInterpreter::addMapEvent(lua_State *L)
{
    ...
    if (!lua_isstring(L, 1))
    {
        lua_pushfstring(L, "addMapEvent: bad argument #1 type (uniquename as string expected, got %s!)",
                        luaL_typename(L, 1));
        lua_error(L);
        return 1;
    }
    ...
    if (!lua_isstring(L, 2))
    {
        lua_pushfstring(L, "addMapEvent: bad argument #2 type (event name as string expected, got %s!)",
                        luaL_typename(L, 2));
        lua_error(L);
        return 1;
    }
...
int TLuaInterpreter::feedTriggers(lua_State *L)
{
    ...
    if (lua_gettop(L) > 1)
    {
        ...
        {
            lua_pushfstring(L, "feedTriggers: bad argument #2 type (Utf8Encoded as boolean is optional, got %s!)",
                            luaL_typename(L, 2));
            return lua_error(L);
        }
    ...
    if (dataIsUtf8Encoded)
    {
        ...
        if (!(currentEncoding.isEmpty() || currentEncoding == QStringLiteral("ASCII")))
        {
            if (!pDataCodec->canEncode(dataQString))
            {
                lua_pushnil(L);
                lua_pushfstring(L,
                                "cannot send \"%s\" as it contains one or more characters that cannot be conveyed in "
                                "the current game server encoding of \"%s\"",
                                data.constData(), currentEncoding.toLatin1().constData());
                return 2;
            }
        ...
        for (int i = 0, total = dataQString.size(); i < total; ++i)
        {
            if (dataQString.at(i).row() || dataQString.at(i).cell() > 127)
            {
                ...
                lua_pushfstring(L,
                                "cannot send \"%s\" as it contains one or more characters that cannot be conveyed in "
                                "the current game server encoding of \"ASCII\"",
                                data.constData());
                return 2;
            }
        }
...
int TLuaInterpreter::getColumnNumber(lua_State *L)
{
    ...
    if (lua_gettop(L))
    {
        if (!lua_isstring(L, 1))
        {
            lua_pushfstring(L, "getColumnNumber: bad argument #1 type (window name as string expected, got %s!)",
                            luaL_typename(L, 1));
            return lua_error(L);
        }
        else
...
int TLuaInterpreter::getStopWatchTime(lua_State *L)
{
    ...
    {
        lua_pushfstring(
            L, "getStopWatchTime: bad argument #1 type (stopwatch id as number or name as string expected, got %s!)",
            luaL_typename(L, 1));
        return lua_error(L);
    }
    ...
    else
    {
        ...
        if (Q_UNLIKELY(!result.first))
        {
            lua_pushnil(L);
            lua_pushfstring(L,
                            "stopwatch with name \"%s\" (id: %d) has disappeared - this should not happen, please "
                            "report it to Mudlet developers",
                            name.toUtf8().constData(), watchId);
            return 2;
        }
    }
...
int TLuaInterpreter::createStopWatch(lua_State *L)
{
    ...
    if (n)
    {
        ...
        else
        {
            lua_pushfstring(
                L,
                "createStopWatch: bad argument #%d type (name as string or autostart as boolean are optional, got %s!)",
                s, luaL_typename(L, s));
            return lua_error(L);
        }
        ...
        if (n > 1)
        {
            ...
            {
                lua_pushfstring(L, "createStopWatch: bad argument #%d type (autostart as boolean is optional, got %s!)",
                                s, luaL_typename(L, s));
                return lua_error(L);
            }
        }
...
int TLuaInterpreter::stopStopWatch(lua_State *L)
{
    ...
    {
        lua_pushfstring(
            L, "stopStopWatch: bad argument #1 type (stopwatch id as number or name as string expected, got %s!)",
            luaL_typename(L, 1));
        return lua_error(L);
    }
...
int TLuaInterpreter::startStopWatch(lua_State *L)
{
    ...
    {
        lua_pushfstring(
            L, "startStopWatch: bad argument #1 type (stopwatch id as number or name as string expected, got %s!)",
            luaL_typename(L, 1));
        return lua_error(L);
    }
    ...
    if (lua_type(L, 1) == LUA_TNUMBER)
    {
        ...
        if (lua_gettop(L) > 1)
        {
            ...
            {
                lua_pushfstring(L,
                                "startStopWatch: bad argument #2 type (automatic reset and restart as boolean is "
                                "optional with a numeric stopwatch id, got %s!)",
                                luaL_typename(L, 2));
                return lua_error(L);
            }
...
int TLuaInterpreter::resetStopWatch(lua_State *L)
{
    ...
    {
        lua_pushfstring(
            L, "resetStopWatch: bad argument #1 type (stopwatch id as number or name as string expected, got %s!)",
            luaL_typename(L, 1));
        return lua_error(L);
    }
...
int TLuaInterpreter::adjustStopWatch(lua_State *L)
{
    ...
    {
        lua_pushfstring(
            L, "adjustStopWatch: bad argument #1 type (stopwatch id as number or name as string expected, got %s!)",
            luaL_typename(L, 1));
        return lua_error(L);
    }
    ...
    {
        lua_pushfstring(L,
                        "adjustStopWatch: bad argument #2 type (modification in seconds as number expected, got %s!)",
                        luaL_typename(L, 2));
        return lua_error(L);
    }
...
int TLuaInterpreter::deleteStopWatch(lua_State *L)
{
    ...
    {
        lua_pushfstring(
            L, "deleteStopWatch: bad argument #1 type (stopwatch id as number or name as string expected, got %s!)",
            luaL_typename(L, 1));
        return lua_error(L);
    }
...
int TLuaInterpreter::setStopWatchPersistence(lua_State *L)
{
    ...
    {
        lua_pushfstring(L,
                        "setStopWatchPersistence: bad argument #1 type (stopwatch id as number or name as string "
                        "expected, got %s!)",
                        luaL_typename(L, 1));
        return lua_error(L);
    }
    ...
    if (!lua_isboolean(L, 2))
    {
        lua_pushfstring(L, "setStopWatchPersistence: bad argument #2 type (persistence as boolean expected, got %s!)",
                        luaL_typename(L, 2));
        return lua_error(L);
    }
...
int TLuaInterpreter::setStopWatchName(lua_State *L)
{
    ...
    {
        lua_pushfstring(L,
                        "setStopWatchName: bad argument #1 type (stopwatch id as number or current name as string "
                        "expected, got %s!)",
                        luaL_typename(L, 1));
        return lua_error(L);
    }
    ...
    if (!lua_isstring(L, 2))
    {
        lua_pushfstring(L, "setStopWatchName: bad argument #2 type (stopwatch new name as string expected, got %s!)",
                        luaL_typename(L, 1));
        return lua_error(L);
    }
...
void TLuaInterpreter::generateElapsedTimeTable(lua_State *L, const QStringList &elapsedTimeSplitString,
                                               const bool includeDecimalSeconds, const qint64 elapsedTimeMilliSeconds)
{
    lua_newtable(L);
...
int TLuaInterpreter::getStopWatchBrokenDownTime(lua_State *L)
{
    ...
    {
        lua_pushfstring(L,
                        "getStopWatchBrokenDownTime: bad argument #1 type (stopwatch id as number or name as string "
                        "expected, got %s!)",
                        luaL_typename(L, 1));
        return lua_error(L);
    }
...
int TLuaInterpreter::selectSection(lua_State *L)
{
    ...
    if (argumentsCount > 2)
    {
        if (!lua_isstring(L, s))
        {
            lua_pushfstring(L, "selectSection: bad argument #1 type (window name as string expected, got %s!)",
                            luaL_typename(L, 1));
            return lua_error(L);
        }
        else
    ...
    if (!lua_isnumber(L, s))
    {
        lua_pushfstring(L, "selectSection: bad argument #%d type (from position as number expected, got %s!)", s,
                        luaL_typename(L, 1));
        return lua_error(L);
    }
    else
    ...
    if (!lua_isnumber(L, s))
    {
        lua_pushfstring(L, "selectSection: bad argument #%d type (length as number expected, got %s!)", s,
                        luaL_typename(L, 1));
        return lua_error(L);
    }
    else
...
int TLuaInterpreter::getSelection(lua_State *L)
{
    ...
    if (lua_gettop(L) > 0)
    {
        if (!lua_isstring(L, 1))
        {
            lua_pushfstring(L, "getSelection: bad argument #1 type (window name as string expected, got %s!)",
                            luaL_typename(L, 1));
            return lua_error(L);
        }
        else
...
int TLuaInterpreter::enableScrollBar(lua_State *L)
{
    ...
    if (n == 1)
    {
        if (!lua_isstring(L, 1))
        {
            lua_pushfstring(L, "enableScrollBar: bad argument #1 type (window name as string expected, got %s!)",
                            luaL_typename(L, 1));
            lua_error(L);
            return 1;
        }
...
int TLuaInterpreter::disableScrollBar(lua_State *L)
{
    ...
    if (n == 1)
    {
        if (!lua_isstring(L, 1))
        {
            lua_pushfstring(L, "disableScrollBar: bad argument #1 type (window name as string expected, got %s!)",
                            luaL_typename(L, 1));
            lua_error(L);
            return 1;
        }
...
int TLuaInterpreter::setModulePriority(lua_State *L)
{
    ...
    if (!lua_isstring(L, 1))
    {
        lua_pushfstring(L, "setModulePriority: bad argument #1 type (module name as string expected, got %s!)",
                        luaL_typename(L, 1));
        lua_error(L);
        return 1;
    }
    ...
    if (!lua_isnumber(L, 2))
    {
        lua_pushfstring(L, "setModulePriority: bad argument #2 type (module priority as number expected, got %s!)",
                        luaL_typename(L, 2));
        lua_error(L);
        return 1;
    }
...
int TLuaInterpreter::enableScript(lua_State *L)
{
    if (!lua_isstring(L, 1))
    {
        lua_pushfstring(L, "enableScript: bad argument #1 type (script name as string expected, got %s!)",
                        luaL_typename(L, 1));
        return lua_error(L);
    }
    QString name = QString::fromUtf8(lua_tostring(L, 1));
...
int TLuaInterpreter::disableScript(lua_State *L)
{
    if (!lua_isstring(L, 1))
    {
        lua_pushfstring(L, "disableScript: bad argument #1 type (script name as string expected, got %s!)",
                        luaL_typename(L, 1));
        return lua_error(L);
    }
    QString name = QString::fromUtf8(lua_tostring(L, 1));
...
int TLuaInterpreter::remainingTime(lua_State *L)
{
    ...
    {
        lua_pushfstring(L,
                        "remainingTime: bad argument #1 (timer name as string or timer id as number expected, got %s!",
                        luaL_typename(L, 1));
        return lua_error(L);
    }
...
int TLuaInterpreter::saveProfile(lua_State *L)
{
    ...
    {
        lua_pushnil(L);
        lua_pushstring(L, QString("Couldn't save %1 to %2 because: %3")
                              .arg(host.getName(), std::get<1>(result), std::get<2>(result))
                              .toUtf8()
                              .constData());
        return 2;
    }
...
int TLuaInterpreter::setFont(lua_State *L)
{
    ...
    { // Have more than one argument so first must be a console name
        if (!lua_isstring(L, ++s))
        {
            lua_pushfstring(L, "setFont: bad argument #%d type for the optional window name - expected string, got %s!",
                            s, luaL_typename(L, s));
            return lua_error(L);
        }
        else
...
int TLuaInterpreter::getFont(lua_State *L)
{
    ...
    if (lua_gettop(L) == 1)
    {
        if (!lua_isstring(L, 1))
        {
            lua_pushfstring(L, "getFont: bad argument #1 type (window name as string expected, got %s!)",
                            luaL_typename(L, 1));
            return lua_error(L);
        }
        else
...
int TLuaInterpreter::setFontSize(lua_State *L)
{
    ...
    if (!lua_isnumber(L, ++s))
    {
        lua_pushfstring(L, "setFontSize: bad argument #%d type (size as number expected, got %s!)", s,
                        luaL_typename(L, s));
        return lua_error(L);
    }
    else
...
int TLuaInterpreter::getFontSize(lua_State *L)
{
    ...
    if (lua_gettop(L) == 1)
    {
        if (!lua_isstring(L, 1))
        {
            lua_pushfstring(L, "getFontSize: bad argument #1 type (window name as string expected, got %s!)",
                            luaL_typename(L, 1));
            return lua_error(L);
        }
        else
...
int TLuaInterpreter::openUserWindow(lua_State *L)
{
    ...
    {
        lua_pushfstring(L, "openUserWindow:  bad argument #1 type (name as string expected, got %s!)",
                        luaL_typename(L, 1));
        return lua_error(L);
    }
    else
    ...
    if (n > 1)
    {
        if (!lua_isboolean(L, 2))
        {
            lua_pushfstring(L, "openUserWindow:  bad argument #2 type (loadLayout as boolean expected, got %s!)",
                            luaL_typename(L, 2));
            return lua_error(L);
        }
        else
    ...
    if (n > 2)
    {
        if (!lua_isboolean(L, 3))
        {
            lua_pushfstring(L, "openUserWindow:  bad argument #3 type (autoDock as boolean expected, got %s!)",
                            luaL_typename(L, 3));
            return lua_error(L);
        }
        else
    ...
    if (n > 3)
    {
        ...
        {
            lua_pushfstring(L, "openUserWindow: bad argument #4 type (area as string expected, got %s!)",
                            luaL_typename(L, 4));
            return lua_error(L);
        }
        else
    ...
    if (auto [success, message] = mudlet::self()->openWindow(&host, name, loadLayout, autoDock, area.toLower());
        !success)
    {
        lua_pushnil(L);
        lua_pushfstring(L, message.toUtf8().constData());
...
int TLuaInterpreter::setUserWindowTitle(lua_State *L)
{
    if (!lua_isstring(L, 1))
    {
        lua_pushfstring(L, "setUserWindowTitle: bad argument #1 type (name as string expected, got %s!)",
                        luaL_typename(L, 1));
        return lua_error(L);
    }
    QString name = QString::fromUtf8(lua_tostring(L, 1));
    ...
    if (lua_gettop(L) > 1)
    {
        if (!lua_isstring(L, 2))
        {
            lua_pushfstring(L, "setUserWindowTitle: bad argument #2 type (title as string is optional, got %s!)",
                            luaL_typename(L, 2));
            return lua_error(L);
        }
...
int TLuaInterpreter::setMapWindowTitle(lua_State *L)
{
    ...
    if (lua_gettop(L))
    {
        if (!lua_isstring(L, 1))
        {
            lua_pushfstring(L, "setMapWindowTitle: bad argument #1 type (title as string is optional, got %s!)",
                            luaL_typename(L, 1));
            return lua_error(L);
        }
...
int TLuaInterpreter::getMudletInfo(lua_State *L)
{
    ...
    while (encodingNames.lastIndexOf(needle, startLineIndex + maxLineLength) >= 0)
    {
        ...
        endLineIndex =
            std::min(encodingNames.lastIndexOf(needle, startLineIndex + maxLineLength), startLineIndex + maxLineLength);
    ...
    QString rawMessage{tr("============================== Mudlet Information ==============================\n"
                          ...
                          "(which are always in Engineering English)")
                           .arg(QLatin1String(currentEncoding), encodingNames)};
...
int TLuaInterpreter::createMiniConsole(lua_State *L)
{
    ...
    if (!lua_isstring(L, 1))
    {
        lua_pushfstring(L, "createMiniConsole: bad argument #1 type (miniconsole name as string expected, got %s!)",
                        luaL_typename(L, 1));
        lua_error(L);
        return 1;
    }
    ...
    if (!lua_isnumber(L, 2))
    {
        if (!lua_isstring(L, 2))
        {
            lua_pushfstring(L, "createMiniConsole: bad argument #2 type (miniconsole name as string expected, got %s!)",
                            luaL_typename(L, 2));
            lua_error(L);
            return 1;
        }
    ...
    {
        lua_pushfstring(
            L, "createMiniConsole: bad argument #%d type (miniconsole x-coordinate as number expected, got %s!)",
            counter, luaL_typename(L, counter));
        lua_error(L);
        return 1;
    }
    else
    ...
    {
        lua_pushfstring(
            L, "createMiniConsole: bad argument #%d type (miniconsole y-coordinate as number expected, got %s!)",
            counter, luaL_typename(L, counter));
        lua_error(L);
        return 1;
    }
    ...
    if (!lua_isnumber(L, counter))
    {
        lua_pushfstring(L, "createMiniConsole: bad argument #%d type (miniconsole width as number expected, got %s!)",
                        counter, luaL_typename(L, counter));
        lua_error(L);
        return 1;
    }
    ...
    if (!lua_isnumber(L, counter))
    {
        lua_pushfstring(L, "createMiniConsole: bad argument #%d type (miniconsole height as number expected, got %s!)",
                        counter, luaL_typename(L, counter));
        lua_error(L);
        return 1;
    }
    ...
    if (auto [success, message] = mudlet::self()->createMiniConsole(&host, windowname, name, x, y, width, height);
        !success)
    {
        lua_pushboolean(L, false);
        lua_pushfstring(L, message.toUtf8().constData());
...
int TLuaInterpreter::createLabel(lua_State *L)
{
    ...
    {
        lua_pushfstring(L,
                        "createLabel: bad argument #1 type (label or parent window name as string expected, got %s!)",
                        luaL_typename(L, 1));
        return lua_error(L);
    }
    ...
    {
        lua_pushfstring(L,
                        "createLabel: bad argument #2 type (label name as string or label x-coordinate as number "
                        "expected, got %s!)",
                        luaL_typename(L, 2));
        return lua_error(L);
    }
...
int TLuaInterpreter::createLabelUserWindow(lua_State *L, const QString &windowName, const QString &labelName)
{
    ...
    if (!lua_isnumber(L, 3))
    {
        lua_pushfstring(L, "createLabel: bad argument #3 type (label x-coordinate as number expected, got %s!)",
                        luaL_typename(L, 3));
        return lua_error(L);
    }
    else
    ...
    if (!lua_isnumber(L, 4))
    {
        lua_pushfstring(L, "createLabel: bad argument #4 type (label y-coordinate as number expected, got %s!)",
                        luaL_typename(L, 4));
        return lua_error(L);
    }
    else
    ...
    if (!lua_isnumber(L, 5))
    {
        lua_pushfstring(L, "createLabel: bad argument #5 type (label width as number expected, got %s!)",
                        luaL_typename(L, 5));
        return lua_error(L);
    }
    else
    ...
    if (!lua_isnumber(L, 6))
    {
        lua_pushfstring(L, "createLabel: bad argument #6 type (label height as number expected, got %s!)",
                        luaL_typename(L, 6));
        return lua_error(L);
    }
    else
    ...
    {
        lua_pushfstring(
            L, "createLabel: bad argument #7 type (label fillBackground as boolean/number (0/1) expected, got %s!)",
            luaL_typename(L, 7));
        return lua_error(L);
    }
    else
    ...
    if (n >= 8)
    {
        ...
        {
            lua_pushfstring(
                L, "createLabel: bad argument #8 type (label clickthrough as boolean/number (0/1) expected, got %s!)",
                luaL_typename(L, 8));
            return lua_error(L);
        }
        else
    ...
    Host &host = getHostFromLua(L);
    if (auto [success, message] = mudlet::self()->createLabel(&host, windowName, labelName, x, y, width, height,
                                                              fillBackground, clickthrough);
        !success)
    {
...
int TLuaInterpreter::createLabelMainWindow(lua_State *L, const QString &labelName)
{
    ...
    if (!lua_isnumber(L, 2))
    {
        lua_pushfstring(L, "createLabel: bad argument #2 type (label x-coordinate as number expected, got %s!)",
                        luaL_typename(L, 2));
        return lua_error(L);
    }
    else
    ...
    if (!lua_isnumber(L, 3))
    {
        lua_pushfstring(L, "createLabel: bad argument #3 type (label y-coordinate as number expected, got %s!)",
                        luaL_typename(L, 3));
        return lua_error(L);
    }
    else
    ...
    if (!lua_isnumber(L, 4))
    {
        lua_pushfstring(L, "createLabel: bad argument #4 type (label width as number expected, got %s!)",
                        luaL_typename(L, 4));
        return lua_error(L);
    }
    else
    ...
    if (!lua_isnumber(L, 5))
    {
        lua_pushfstring(L, "createLabel: bad argument #5 type (label height as number expected, got %s!)",
                        luaL_typename(L, 5));
        return lua_error(L);
    }
    else
    ...
    {
        lua_pushfstring(
            L, "createLabel: bad argument #6 type (label fillBackground as boolean/number (0/1) expected, got %s!)",
            luaL_typename(L, 6));
        return lua_error(L);
    }
    else
    ...
    if (n >= 7)
    {
        ...
        {
            lua_pushfstring(
                L, "createLabel: bad argument #7 type (label clickthrough as boolean/number (0/1) expected, got %s!)",
                luaL_typename(L, 7));
            return lua_error(L);
        }
        else
...
int TLuaInterpreter::deleteLabel(lua_State *L)
{
    if (!lua_isstring(L, 1))
    {
        lua_pushfstring(L, "deleteLabel: bad argument #1 type (label name as string expected, got %s!)",
                        luaL_typename(L, 1));
        return lua_error(L);
    }
...
int TLuaInterpreter::setLabelToolTip(lua_State *L)
{
    if (!lua_isstring(L, 1))
    {
        lua_pushfstring(L, "setLabelToolTip: bad argument #1 type (label name as string expected, got %s!)",
                        luaL_typename(L, 1));
        return lua_error(L);
    }
    if (!lua_isstring(L, 2))
    {
        lua_pushfstring(L, "setLabelToolTip: bad argument #2 type (text as string expected, got %s!)",
                        luaL_typename(L, 2));
        return lua_error(L);
    }
    if ((lua_gettop(L) > 2) && !lua_isnumber(L, 3))
    {
        lua_pushfstring(L, "setLabelToolTip: bad argument #3 type (duration as number expected, got %s!)",
                        luaL_typename(L, 3));
        return lua_error(L);
    }
...
int TLuaInterpreter::setLabelCursor(lua_State *L)
{
    if (!lua_isstring(L, 1))
    {
        lua_pushfstring(L, "setLabelCursor: bad argument #1 type (label name as string expected, got %s!)",
                        luaL_typename(L, 1));
        return lua_error(L);
    }
    if (!lua_isnumber(L, 2))
    {
        lua_pushfstring(L, "setLabelCursor: bad argument #2 type (cursortype as number expected, got %s!)",
                        luaL_typename(L, 2));
        return lua_error(L);
    }
...
int TLuaInterpreter::setLabelCustomCursor(lua_State *L)
{
    ...
    if (!lua_isstring(L, 1))
    {
        lua_pushfstring(L, "setLabelCustomCursor: bad argument #1 type (label name as string expected, got %s!)",
                        luaL_typename(L, 1));
        return lua_error(L);
    }
    if (!lua_isstring(L, 2))
    {
        lua_pushfstring(
            L, "setLabelCustomCursor: bad argument #2 type (custom cursor location as string expected, got %s!)",
            luaL_typename(L, 2));
        return lua_error(L);
    }
    ...
    if (n > 2)
    {
        ...
        {
            lua_pushfstring(
                L, "setLabelCustomCursor: bad argument #3 type (hot spot x-coordinate as number expected, got %s!)",
                luaL_typename(L, 3));
            return lua_error(L);
        }
        if (!lua_isnumber(L, 4))
        {
            lua_pushfstring(
                L, "setLabelCustomCursor: bad argument #4 type (hot spot y-coordinate as number expected, got %s!)",
                luaL_typename(L, 4));
            return lua_error(L);
        }
...
int TLuaInterpreter::createMapper(lua_State *L)
{
    ...
    {
        lua_pushfstring(L, "createMapper: bad argument #1 type (parent window name as string expected, got %s!)",
                        luaL_typename(L, 1));
        return lua_error(L);
    }
    if (n > 4 && lua_type(L, 1) == LUA_TSTRING)
    ...
    if (!lua_isnumber(L, counter))
    {
        lua_pushfstring(L, "createMapper: bad argument #%d type (mapper x-coordinate as number expected, got %s!)",
                        counter, luaL_typename(L, counter));
        return lua_error(L);
    }
    else
    ...
    if (!lua_isnumber(L, counter))
    {
        lua_pushfstring(L, "createMapper: bad argument #%d type (mapper y-coordinate as number expected, got %s!)",
                        counter, luaL_typename(L, counter));
        return lua_error(L);
    }
    else
    ...
    if (!lua_isnumber(L, counter))
    {
        lua_pushfstring(L, "createMapper: bad argument #%d type (mapper width as number expected, got %s!)", counter,
                        luaL_typename(L, counter));
        return lua_error(L);
    }
    else
    {
    ...
    if (!lua_isnumber(L, counter))
    {
        lua_pushfstring(L, "createMapper: bad argument #%d type (mapper height as number expected, got %s!)", counter,
                        luaL_typename(L, counter));
        return lua_error(L);
    }
    else
...
// Documentation: ? - public function but should stay undocumented -- compare
// https://github.com/Mudlet/Mudlet/issues/1149
...
// Documentation: https://wiki.mudlet.org/w/Manual:Lua_Functions#hideWindow -- not hideUserWindow - compare
// initLuaGlobals()
...
void TLuaInterpreter::setBorderSize(lua_State *L, int size, int position, bool resizeMudlet)
{
    ...
    {
    case Qt::TopSection:
        host.mBorderTopHeight = size;
        break;
    case Qt::RightSection:
        host.mBorderRightWidth = size;
        break;
    case Qt::BottomSection:
        host.mBorderBottomHeight = size;
        break;
    case Qt::LeftSection:
        host.mBorderLeftWidth = size;
        break;
    }
    if (resizeMudlet)
    {
...
int TLuaInterpreter::setBorderSizes(lua_State *L)
{
    ...
    case 1: {
        if (!lua_isnumber(L, 1))
        {
            lua_pushfstring(L, "setBorderSizes: bad argument #1 value (new size as number expected, got %s!)",
                            luaL_typename(L, 1));
            return lua_error(L);
        }
    ...
    case 2: {
        if (!lua_isnumber(L, 1))
        {
            lua_pushfstring(L, "setBorderSizes: bad argument #1 value (new height as number expected, got %s!)",
                            luaL_typename(L, 1));
            return lua_error(L);
        }
        if (!lua_isnumber(L, 2))
        {
            lua_pushfstring(L, "setBorderSizes: bad argument #2 value (new width as number expected, got %s!)",
                            luaL_typename(L, 2));
            return lua_error(L);
        }
        sizeTop = lua_tonumber(L, 1);
    ...
    case 3: {
        if (!lua_isnumber(L, 1))
        {
            lua_pushfstring(L, "setBorderSizes: bad argument #1 value (new top size as number expected, got %s!)",
                            luaL_typename(L, 1));
            return lua_error(L);
        }
        if (!lua_isnumber(L, 2))
        ...
        if (!lua_isnumber(L, 3))
        {
            lua_pushfstring(L, "setBorderSizes: bad argument #3 value (new bottom size as number expected, got %s!)",
                            luaL_typename(L, 3));
            return lua_error(L);
        }
        sizeTop = lua_tonumber(L, 1);
    ...
    default: {
        ...
        if (!lua_isnumber(L, 2))
        {
            lua_pushfstring(L, "setBorderSizes: bad argument #2 value (new right size as number expected, got %s!)",
                            luaL_typename(L, 2));
            return lua_error(L);
        }
        if (!lua_isnumber(L, 3))
        ...
        if (!lua_isnumber(L, 4))
        {
            lua_pushfstring(L, "setBorderSizes: bad argument #4 value (new left size as number expected, got %s!)",
                            luaL_typename(L, 4));
            return lua_error(L);
        }
        sizeTop = lua_tonumber(L, 1);
...
int TLuaInterpreter::setBorderTop(lua_State *L)
{
    if (!lua_isnumber(L, 1))
    {
        lua_pushfstring(L, "setBorderTop: bad argument #1 value (new size as number expected, got %s!)",
                        luaL_typename(L, 1));
        return lua_error(L);
    }
...
int TLuaInterpreter::setBorderRight(lua_State *L)
{
    if (!lua_isnumber(L, 1))
    {
        lua_pushfstring(L, "setBorderRight: bad argument #1 value (new size as number expected, got %s!)",
                        luaL_typename(L, 1));
        return lua_error(L);
    }
    int size = lua_tonumber(L, 1);
...
int TLuaInterpreter::setBorderBottom(lua_State *L)
{
    if (!lua_isnumber(L, 1))
    {
        lua_pushfstring(L, "setBorderBottom: bad argument #1 value (new size as number expected, got %s!)",
                        luaL_typename(L, 1));
        return lua_error(L);
    }
    int size = lua_tonumber(L, 1);
...
int TLuaInterpreter::setBorderLeft(lua_State *L)
{
    if (!lua_isnumber(L, 1))
    {
        lua_pushfstring(L, "setBorderLeft: bad argument #1 value (new size as number expected, got %s!)",
                        luaL_typename(L, 1));
        return lua_error(L);
    }
    int size = lua_tonumber(L, 1);
...
// Documentation: https://wiki.mudlet.org/w/Manual:Lua_Functions#resizeWindow -- not resizeUserWindow - compare
// initLuaGlobals()
...
int TLuaInterpreter::setWindow(lua_State *L)
{
    ...
    if (lua_type(L, 1) != LUA_TSTRING)
    {
        lua_pushfstring(L, "setWindow: bad argument #1 type (parent windowname as string expected, got %s!)",
                        luaL_typename(L, 1));
        return lua_error(L);
    }
    else
    ...
    {
        lua_pushfstring(L, "setWindow: bad argument #2 type (element name as string expected, got %s!)",
                        luaL_typename(L, 2));
        return lua_error(L);
    }
    else
    ...
    if (n > 2)
    {
        if (!lua_isnumber(L, 3))
        {
            lua_pushfstring(L, "setWindow: bad argument #3 type (x-coordinate as number expected, got %s!)",
                            luaL_typename(L, 3));
            return lua_error(L);
        }
        else
        ...
        if (!lua_isnumber(L, 4))
        {
            lua_pushfstring(L, "setWindow: bad argument #4 type (y-coordinate as number expected, got %s!)",
                            luaL_typename(L, 4));
            return lua_error(L);
        }
        else
        ...
        {
            lua_pushfstring(L, "setWindow: bad argument #5 type (show element as boolean expected, got %s!)",
                            luaL_typename(L, 5));
            return lua_error(L);
        }
        else
...
int TLuaInterpreter::openMapWidget(lua_State *L)
{
    ...
    if (n == 1)
    {
        if (lua_type(L, 1) != LUA_TSTRING)
        {
            lua_pushfstring(L, "openMapWidget: bad argument #1 type (area as string expected, got %s!)",
                            luaL_typename(L, 1));
            return lua_error(L);
        }
        else
    ...
    if (n > 1)
    {
        ...
        if (!lua_isnumber(L, 1))
        {
            lua_pushfstring(L, "openMapWidget: bad argument #1 type (x-coordinate as number expected, got %s!)",
                            luaL_typename(L, 1));
            return lua_error(L);
        }
        else
        ...
        if (!lua_isnumber(L, 2))
        {
            lua_pushfstring(L, "openMapWidget: bad argument #2 type (y-coordinate as number expected, got %s!)",
                            luaL_typename(L, 2));
            return lua_error(L);
        }
        else
    ...
    if (n > 2)
    {
        if (!lua_isnumber(L, 3))
        {
            lua_pushfstring(L, "openMapWidget: bad argument #3 type (width as number expected, got %s!)",
                            luaL_typename(L, 3));
            return lua_error(L);
        }
        else
        ...
        if (!lua_isnumber(L, 4))
        {
            lua_pushfstring(L, "openMapWidget: bad argument #4 type (height as number expected, got %s!)",
                            luaL_typename(L, 4));
            return lua_error(L);
        }
        else
...
int TLuaInterpreter::setBackgroundColor(lua_State *L)
{
    ...
    if (lua_isstring(L, s) && !lua_isnumber(L, s))
    {
        ...
        {
            lua_pushfstring(L,
                            "setBackgroundColor: bad argument #%d type (red value 0-255 as number expected, got %s!)",
                            s, luaL_typename(L, s));
            return lua_error(L);
        }
        else
        {
            ...
            if (!validRange(r))
            {
                lua_pushnil(L);
                lua_pushfstring(
                    L, "setBackgroundColor: bad argument #%d value (red value needs to be between 0-255, got %d!)", s,
                    r);
                return 2;
            }
        }
    ...
    else if (lua_isnumber(L, s))
    {
        ...
        if (!validRange(r))
        {
            lua_pushnil(L);
            lua_pushfstring(
                L, "setBackgroundColor: bad argument #%d value (red value needs to be between 0-255, got %d!)", s, r);
            return 2;
        }
    }
    else
    {
        lua_pushfstring(L,
                        "setBackgroundColor: bad argument #%d type (window name as string, or red value 0-255 as "
    ...
    if (!lua_isnumber(L, ++s))
    {
        lua_pushfstring(L, "setBackgroundColor: bad argument #%d type (green value 0-255 as number expected, got %s!)",
                        s, luaL_typename(L, s));
        return lua_error(L);
    }
    else
    {
        ...
        if (!validRange(g))
        {
            lua_pushnil(L);
            lua_pushfstring(
                L, "setBackgroundColor: bad argument #%d value (green value needs to be between 0-255, got %d!)", s, g);
            return 2;
        }
    }
    ...
    if (!lua_isnumber(L, ++s))
    {
        lua_pushfstring(L, "setBackgroundColor: bad argument #%d type (blue value 0-255 as number expected, got %s!)",
                        s, luaL_typename(L, s));
        return lua_error(L);
    }
    else
    {
        ...
        if (!validRange(b))
        {
            lua_pushnil(L);
            lua_pushfstring(
                L, "setBackgroundColor: bad argument #%d value (blue value needs to be between 0-255, got %d!)", s, b);
            return 2;
        }
    }
    ...
    {
        lua_pushfstring(
            L, "setBackgroundColor: bad argument #%d type (optional alpha value 0-255 as number expected, got %s!)", s,
            luaL_typename(L, s));
        return lua_error(L);
    }
    else
    {
        ...
        if (!validRange(alpha))
        {
            lua_pushnil(L);
            lua_pushfstring(
                L, "setBackgroundColor: bad argument #%d value (alpha value needs to be between 0-255, got %d!)", s,
                alpha);
            return 2;
        }
    }
...
int TLuaInterpreter::calcFontSize(lua_State *L)
{
    ...
    if (lua_gettop(L) == 2)
    {
        if (!lua_isnumber(L, 1))
        {
            lua_pushfstring(L, R"(calcFontSize: bad argument #1 (font size as number expected, got %s!)",
                            luaL_typename(L, 1));
            return lua_error(L);
        }
        ...
        if (!lua_isstring(L, 2))
        {
            lua_pushfstring(L, R"(calcFontSize: bad argument #2 (font name as string expected, got %s!)",
                            luaL_typename(L, 2));
            return lua_error(L);
        }
    ...
    {
        lua_pushfstring(L, "calcFontSize: bad argument #1 type (window name as string expected, got %s!)",
                        luaL_typename(L, 1));
        return lua_error(L);
    }
    else
    ...
    if (host.mpConsole->mLogToLogFile != logOn)
    {
        ...
        if (host.mpConsole->mLogToLogFile)
        {
            ...
            lua_pushfstring(L, "Main console output has started to be logged to file: %s.",
                            host.mpConsole->mLogFileName.toUtf8().constData());
...
int TLuaInterpreter::getImageSize(lua_State *L)
{
    ...
    if (!lua_isstring(L, 1))
    {
        lua_pushfstring(L, "getImageSize: bad argument #1 type (image location as string expected, got %s!)",
                        luaL_typename(L, 1));
        return lua_error(L);
    }
    else
    ...
    {
        lua_pushnil(L);
        lua_pushfstring(L, "couldn't retrieve image size, is the location '%s' correct?",
                        imageLocation.toUtf8().constData());
    }
    return 2;
}
...
int TLuaInterpreter::setLabelCallback(lua_State *L, const QString &funcName)
{
    ...
    if (!lua_isstring(L, 1))
    {
        lua_pushfstring(L, "%s: bad argument #1 type (label name as string expected, got %s!)",
    ...
    else
    {
        ...
        {
            lua_pushnil(L);
            lua_pushfstring(L, "%s: bad argument #1 value (label name cannot be an empty string.)",
    ...
    {
        lua_pushfstring(L, "%s: bad argument #2 type (function expected, got %s!)", funcName.toUtf8().constData(),
                        luaL_typename(L, 1));
        return lua_error(L);
    }
    ...
    {
        lua_pushnil(L);
        lua_pushfstring(L, R"("%s" is not a known function name - bug in Mudlet, please report it)",
                        funcName.toUtf8().constData());
        return 2;
    }
    ...
    {
        lua_pushnil(L);
        lua_pushfstring(L, R"("%s": bad argument #1 value (label name "%s" not found.))", funcName.toUtf8().constData(),
...
int TLuaInterpreter::setTextFormat(lua_State *L)
{
    ...
    if (!lua_isstring(L, ++s))
    {
        lua_pushfstring(L, "setTextFormat: bad argument #%d type (window name as string is optional, got %s!)", s,
                        luaL_typename(L, s));
        return lua_error(L);
    }
    else
    ...
    {
        lua_pushfstring(L,
                        "setTextFormat: bad argument #%d type (bold format as boolean or number {true/non-zero to "
                        "enable} expected, got %s!)",
                        s, luaL_typename(L, s));
        return lua_error(L);
    }
    ...
    {
        lua_pushfstring(L,
                        "setTextFormat: bad argument #%d type (underline format as boolean or number {true/non-zero to "
                        "enable} expected, got %s!)",
                        s, luaL_typename(L, s));
        return lua_error(L);
    }
    ...
    {
        lua_pushfstring(L,
                        "setTextFormat: bad argument #%d type (italic format as boolean or number {true/non-zero to "
                        "enable} expected, got %s!)",
                        s, luaL_typename(L, s));
        return lua_error(L);
    }
    ...
    if (s < n)
    {
        ...
        else
        {
            lua_pushfstring(L,
                            ...
                            "{true/non-zero to enable} is optional, got %s!)",
                            s, luaL_typename(L, s));
            return lua_error(L);
        }
    }
    ...
    if (s < n)
    {
        ...
        {
            lua_pushfstring(L,
                            "setTextFormat: bad argument #%d type (overline format as boolean or number {true/non-zero "
                            "to enable} is optional, got %s!)",
                            s, luaL_typename(L, s));
            return lua_error(L);
        }
    }
    ...
    if (s < n)
    {
        ...
        {
            lua_pushfstring(L,
                            "setTextFormat: bad argument #%d type (reverse format as boolean or number {true/non-zero "
                            "to enable} is optional, got %s!)",
                            s, luaL_typename(L, s));
            return lua_error(L);
        }
    ...
    TChar::AttributeFlags flags =
        (bold ? TChar::Bold : TChar::None) | (italics ? TChar::Italic : TChar::None) |
        (overline ? TChar::Overline : TChar::None) | (reverse ? TChar::Reverse : TChar::None) |
        (strikeout ? TChar::StrikeOut : TChar::None) | (underline ? TChar::Underline : TChar::None);
    ...
    {
        lua_pushboolean(L, mudlet::self()->setTextFormat(
                               &host, windowName,
                               QColor(colorComponents.at(3), colorComponents.at(4), colorComponents.at(5)),
                               QColor(colorComponents.at(0), colorComponents.at(1), colorComponents.at(2)), flags));
    }
...
// Documentation: https://wiki.mudlet.org/w/Manual:Lua_Functions#showWindow -- not showUserWindow - compare
// initLuaGlobals()
...
int TLuaInterpreter::setRoomEnv(lua_State *L)
{
    ...
    if (!lua_isnumber(L, 1))
    {
        lua_pushfstring(L, "setRoomEnv: bad argument #1 type (room id as number expected, got %s!)",
                        luaL_typename(L, 1));
        return lua_error(L);
    }
    else
    ...
    if (!lua_isnumber(L, 2))
    {
        lua_pushfstring(L, "setRoomEnv: bad argument #2 type (environment id as number expected, got %s!)",
                        luaL_typename(L, 2));
        return lua_error(L);
    }
    else
...
int TLuaInterpreter::connectToServer(lua_State *L)
{
    ...
    if (!lua_isstring(L, 1))
    {
        lua_pushfstring(L, "connectToServer: bad argument #1 type (url as string expected, got %s!)",
                        lua_typename(L, 1));
        return lua_error(L);
    }
    else
    ...
    if (!lua_isnoneornil(L, 2))
    {
        ...
        {
            lua_pushfstring(
                L, "connectToServer: bad argument #2 type (port number as number is optional {default = 23}, got %s!)",
                lua_typename(L, 2));
            return lua_error(L);
        }
        else
        {
            ...
            if (port > 65535 || port < 1)
            {
                lua_pushnil(L);
                lua_pushfstring(L,
                                "invalid port number %d given, if supplied it must be in range 1 to 65535, {defaults "
                                "to 23 if not provided}",
                                port);
                return 2;
            }
        }
    ...
    if (!lua_isnoneornil(L, 3))
    {
        if (!lua_isboolean(L, 3))
        {
            lua_pushfstring(
                L,
                "connectToServer: bad argument #3 type (save host name and port number as boolean expected, got %1!)",
                lua_typename(L, 3));
            return lua_error(L);
        }
        else
...
int TLuaInterpreter::setRoomIDbyHash(lua_State *L)
{
    ...
    if (!lua_isnumber(L, 1))
    {
        lua_pushfstring(L, "setRoomIDbyHash: bad argument #1 type (room id as number expected, got %s!)",
                        luaL_typename(L, 1));
        return lua_error(L);
    }
    id = lua_tonumber(L, 1);
...
int TLuaInterpreter::getRoomHashByID(lua_State *L)
{
    ...
    if (!lua_isnumber(L, 1))
    {
        lua_pushfstring(L, "getRoomHashByID: bad argument #1 type (room id as number expected, got %s!)",
                        luaL_typename(L, 1));
        return lua_error(L);
    }
    id = lua_tonumber(L, 1);
        ...
        if (n > 1)
        {
            if (lua_isboolean(L, 2))
            {
                ...
                if (n > 2)
                {
                    ...
                    {
                        lua_pushfstring(
                            L, R"(searchRoom: bad argument #3 type ("exact match" as boolean is optional, got %s!))",
                            luaL_typename(L, 3));
                        lua_error(L);
                        return 1;
                    }
            ...
            {
                lua_pushfstring(
                    L, R"(searchRoom: bad argument #2 type ("case sensitive" as boolean is optional, got %s!))",
                    luaL_typename(L, 2));
                lua_error(L);
                return 1;
            }
...
int TLuaInterpreter::searchRoomUserData(lua_State *L)
{
    ...
    {                            // Find all values for a particular key in every room
    ...
    { // Find all rooms where key and value match
        QSet<int> roomIdsSet;
        while (itRoom.hasNext())
        {
            itRoom.next();
...
int TLuaInterpreter::searchAreaUserData(lua_State *L)
{
    ...
    else
    {
        QSet<int> areaIdsSet;
        while (itArea.hasNext())
        { // Find all areas with a particular key AND value
            itArea.next();
...
int TLuaInterpreter::deselect(lua_State *L)
{
    ...
    QString windowName; // only for case with an argument, will be null if not assigned to which is different from being
                        // empty
    if (lua_gettop(L) > 0)
    {
        if (!lua_isstring(L, 1))
        {
            lua_pushfstring(
                L,
                R"(deselect: bad argument #1 type (window name as string, is optional {defaults to "main" if omitted}, got %s!))",
                luaL_typename(L, 1));
            lua_error(L);
            return 1;
        }
...
int TLuaInterpreter::resetFormat(lua_State *L)
{
    ...
    if (lua_gettop(L) > 0)
    {
        if (!lua_isstring(L, 1))
        {
            lua_pushfstring(
                L,
                R"(resetFormat: bad argument #1 type (window name as string, is optional {defaults to "main" if omitted}, got %s!))",
                luaL_typename(L, 1));
            lua_error(L);
            return 1;
        }
...
int TLuaInterpreter::setAppStyleSheet(lua_State *L)
{
    ...
    if (n)
    {
        if (!lua_isstring(L, ++s))
        {
            lua_pushfstring(L, "setAppStyleSheet: bad argument #%d type (style sheet as string expected, got %s!)", s,
                            luaL_typename(L, s));
            return lua_error(L);
        }
    ...
    if (n > 1)
    {
        if (!lua_isstring(L, ++s))
        {
            lua_pushfstring(L, "setAppStyleSheet: bad argument #%d type (tag as string is optional, got %s!)", s,
                            luaL_typename(L, s));
            return lua_error(L);
        }
...
int TLuaInterpreter::setProfileStyleSheet(lua_State *L)
{
    ...
    if (!lua_isstring(L, 1))
    {
        lua_pushfstring(L, "setProfileStyleSheet: bad argument #1 type (style sheet as string expected, got %s!)",
                        luaL_typename(L, 1));
        return lua_error(L);
    }
...
int TLuaInterpreter::getMudletLuaDefaultPaths(lua_State *L)
{
    ...
    Q_ASSERT_X(pLua, "TLuaInterpreter::getMudletLuaDefaultPaths",
               "nullptr received when looking for the instantiated instance of TLuaInterpreter for a Host.");
...
int TLuaInterpreter::setBold(lua_State *L)
{
    ...
    { // Have more than one argument so first must be a console name
        ...
        {
            lua_pushfstring(L,
                            "setBold: bad argument #%d type (window name, as string expected {omission selects "
                            "\"main\" console window}, got %s!",
                            s, luaL_typename(L, s));
            return lua_error(L);
        }
        else
    ...
    if (!lua_isboolean(L, ++s))
    {
        lua_pushfstring(L, "setBold: bad argument #%d type (enable bold attribute as boolean expected, got %s!)", s,
                        luaL_typename(L, s));
        lua_error(L);
        return 1;
    }
...
int TLuaInterpreter::setItalics(lua_State *L)
{
    ...
    { // Have more than one argument so first must be a console name
        ...
        {
            lua_pushfstring(L,
                            "setItalics: bad argument #%d type (window name, as string expected {omission selects "
                            "\"main\" console window}, got %s!",
                            s, luaL_typename(L, s));
            return lua_error(L);
        }
...
int TLuaInterpreter::setOverline(lua_State *L)
{
    ...
    { // Have more than one argument so first must be a console name
        ...
        {
            lua_pushfstring(L,
                            "setOverline: bad argument #%d type (window name, as string expected {omission selects "
                            "\"main\" console window}, got %s!",
                            s, luaL_typename(L, s));
            return lua_error(L);
        }
    ...
    {
        lua_pushfstring(L,
                        "setOverline: bad argument #%d type (enable underline attribute as boolean expected, got %s!)",
                        s, luaL_typename(L, s));
        lua_error(L);
        return 1;
    }
...
int TLuaInterpreter::setReverse(lua_State *L)
{
    ...
    { // Have more than one argument so first must be a console name
        ...
        {
            lua_pushfstring(L,
                            "setReverse: bad argument #%d type (window name, as string expected {omission selects "
                            "\"main\" console window}, got %s!",
                            s, luaL_typename(L, s));
            return lua_error(L);
        }
    ...
    {
        lua_pushfstring(L,
                        "setReverse: bad argument #%d type (enable underline attribute as boolean expected, got %s!)",
                        s, luaL_typename(L, s));
        lua_error(L);
        return 1;
    }
...
int TLuaInterpreter::setStrikeOut(lua_State *L)
{
    ...
    { // Have more than one argument so first must be a console name
        ...
        {
            lua_pushfstring(L,
                            "setStrikeOut: bad argument #%d type (window name, as string expected {omission selects "
                            "\"main\" console window}, got %s!",
                            s, luaL_typename(L, s));
            return lua_error(L);
        }
    ...
    {
        lua_pushfstring(L,
                        "setStrikeOut: bad argument #%d type (enable strikeout attribute as boolean expected, got %s!)",
                        s, luaL_typename(L, s));
        lua_error(L);
        return 1;
    }
...
int TLuaInterpreter::setUnderline(lua_State *L)
{
    ...
    { // Have more than one argument so first must be a console name
        ...
        {
            lua_pushfstring(L,
                            "setUnderline: bad argument #%d type (window name, as string expected {omission selects "
                            "\"main\" console window}, got %s!",
                            s, luaL_typename(L, s));
            return lua_error(L);
        }
    ...
    {
        lua_pushfstring(L,
                        "setUnderline: bad argument #%d type (enable underline attribute as boolean expected, got %s!)",
                        s, luaL_typename(L, s));
        lua_error(L);
        return 1;
    }
...
int TLuaInterpreter::debug(lua_State *L)
{
    ...
    if (n > 1)
    {
        ...
        {
            luaDebugText +=
                QStringLiteral(" (%1) %2").arg(QString::number(i + 1), QString::fromUtf8(lua_tostring(L, i + 1)));
        }
    }
    else
    {
...
int TLuaInterpreter::sendATCP(lua_State *L)
{
    ...
    if (lua_gettop(L) > 1)
    {
        if (!lua_isstring(L, 2))
        {
            lua_pushfstring(L, "sendATCP: bad argument #2 type (what as string is optional, got %1!)",
                            luaL_typename(L, 2));
            return lua_error(L);
        }
        else
...
int TLuaInterpreter::receiveMSP(lua_State *L)
{
    ...
    if (!lua_isstring(L, 1))
    {
        lua_pushfstring(L, "receiveMSP: bad argument #1 type (message as string expected, got %1!)",
                        luaL_typename(L, 1));
        return lua_error(L);
    }
...
int TLuaInterpreter::sendGMCP(lua_State *L)
{
    ...
    if (lua_gettop(L) > 1)
    {
        if (!lua_isstring(L, 2))
        {
            lua_pushfstring(L, "sendGMCP: bad argument #2 type (what as string is optional, got %1!)",
                            luaL_typename(L, 2));
            return lua_error(L);
        }
        else
...
int TLuaInterpreter::sendMSDP(lua_State *L)
{
    ...
    for (int i = 1; i <= n; ++i)
    {
        if (!lua_isstring(L, i))
        {
            lua_pushfstring(L, "sendMSDP: bad argument #%d type (%s as string expected, got %s!)", i,
                            (i == 1 ? "variable name" : "value"), luaL_typename(L, i));
            return lua_error(L);
        }
    }
...
int TLuaInterpreter::sendTelnetChannel102(lua_State *L)
{
    ...
    {
        lua_pushfstring(
            L, "sendTelnetChannel102: bad argument #1 type (message bytes {2 characters} as string expected, got %s!)",
            luaL_typename(L, 1));
        return lua_error(L);
    }
    else
    {
        ...
        if (msg.length() != 2)
        {
            lua_pushnil(L);
            lua_pushfstring(L,
                            "invalid message of length %d supplied, it should be two bytes (may use lua \\### for each "
                            "byte where ### is a number between 1 and 254)",
                            msg.length());
            return 2;
        }
    }
    ...
    else
    {
        lua_pushnil(L);
        lua_pushfstring(L,
                        "unable to send message as the 102 subchannel support has not been enabled by the MUD Server");
        return 2;
    }
}
...
int TLuaInterpreter::getUserWindowSize(lua_State *L)
{
    ...
    if (!lua_isstring(L, 1))
    {
        lua_pushfstring(L, "getUserWindowSize: bad argument #1 type (name as string expected, got %s!)",
                        luaL_typename(L, 1));
        lua_error(L);
        return 1;
    }
...
int TLuaInterpreter::tempTimer(lua_State *L)
{
    ...
    {
        lua_pushfstring(L,
                        "tempTimer: bad argument #1 type (time in seconds as {maybe decimal} number expected, got %s!)",
                        luaL_typename(L, 1));
        return lua_error(L);
    }
    ...
    if (!lua_isstring(L, 2))
    {
        lua_pushfstring(L, "tempTimer: bad argument #2 type (script or function name as string expected, got %s!)",
                        luaL_typename(L, 2));
        return lua_error(L);
    }
...
int TLuaInterpreter::tempExactMatchTrigger(lua_State *L)
{
    ...
    {
        lua_pushfstring(L,
                        "tempExactMatchTrigger: bad argument #1 type (exact match pattern as string expected, got %s!)",
                        luaL_typename(L, 1));
        return lua_error(L);
    }
    ...
    if (lua_isnumber(L, 3))
    {
        ...
        if (expirationCount < 1)
        {
            lua_pushnil(L);
            lua_pushfstring(L,
                            "tempExactMatchTrigger: bad argument #3 value (trigger expiration count must be greater "
                            "than zero, got %d)",
                            expirationCount);
            return 2;
        }
    ...
    if (lua_isstring(L, 2))
    {
        triggerID = pLuaInterpreter->startTempExactMatchTrigger(exactMatchPattern,
                                                                QString::fromUtf8(lua_tostring(L, 2)), expirationCount);
    }
    ...
    {
        lua_pushfstring(
            L, "tempExactMatchTrigger: bad argument #2 type (code to run as a string or a function expected, got %s!)",
            luaL_typename(L, 2));
        return lua_error(L);
    }
...
int TLuaInterpreter::tempBeginOfLineTrigger(lua_State *L)
{
    ...
    if (!lua_isstring(L, 1))
    {
        lua_pushfstring(L, "tempBeginOfLineTrigger: bad argument #1 type (pattern as string expected, got %s!)",
                        luaL_typename(L, 1));
        return lua_error(L);
    }
    ...
    if (lua_isnumber(L, 3))
    {
        ...
        if (expiryCount < 1)
        {
            lua_pushnil(L);
            lua_pushfstring(L,
                            "tempBeginOfLineTrigger: bad argument #3 value (trigger expiration count must be greater "
                            "than zero, got %d)",
                            expiryCount);
            return 2;
        }
    ...
    {
        triggerID =
            pLuaInterpreter->startTempBeginOfLineTrigger(pattern, QString::fromUtf8(lua_tostring(L, 2)), expiryCount);
    }
    else if (lua_isfunction(L, 2))
    {
    ...
    {
        lua_pushfstring(
            L, "tempBeginOfLineTrigger: bad argument #2 type (code to run as a string or a function expected, got %s!)",
            luaL_typename(L, 2));
        return lua_error(L);
    }
...
int TLuaInterpreter::tempTrigger(lua_State *L)
{
    ...
    if (!lua_isstring(L, 1))
    {
        lua_pushfstring(L, "tempTrigger: bad argument #1 type (substring pattern as string expected, got %s!)",
                        luaL_typename(L, 1));
        return lua_error(L);
    }
    ...
    if (lua_isnumber(L, 3))
    {
        ...
        if (expiryCount < 1)
        {
            lua_pushnil(L);
            lua_pushfstring(
                L, "tempTrigger: bad argument #3 value (trigger expiration count must be greater than zero, got %d)",
                expiryCount);
            return 2;
        }
    }
    ...
    {
        triggerID =
            pLuaInterpreter->startTempTrigger(substringPattern, QString::fromUtf8(lua_tostring(L, 2)), expiryCount);
    }
    else if (lua_isfunction(L, 2))
    {
    ...
    {
        lua_pushfstring(L,
                        "tempTrigger: bad argument #2 type (code to run as a string or a function expected, got %s!)",
                        luaL_typename(L, 2));
        return lua_error(L);
    }
...
int TLuaInterpreter::tempPromptTrigger(lua_State *L)
{
    ...
    if (lua_isnumber(L, 2))
    {
        ...
        if (expiryCount < 1)
        {
            ...
            lua_pushfstring(
                L,
                "tempPromptTrigger: bad argument #2 value (trigger expiration count must be greater than zero, got %d)",
                expiryCount);
            return 2;
        }
    }
    ...
    {
        lua_pushfstring(
            L, "tempPromptTrigger: bad argument #1 type (code to run as a string or a function expected, got %s!)",
            luaL_typename(L, 1));
        return lua_error(L);
    }
...
int TLuaInterpreter::tempColorTrigger(lua_State *L)
{
    ...
    if (!lua_isnumber(L, 1))
    {
        lua_pushfstring(L, "tempColorTrigger: bad argument #1 type (foreground color as number expected, got %s!)",
                        luaL_typename(L, 1));
        return lua_error(L);
    }
    ...
    if (!lua_isnumber(L, 2))
    {
        lua_pushfstring(L, "tempColorTrigger: bad argument #2 type (background color as number is expected, got %s!)",
                        luaL_typename(L, 2));
        return lua_error(L);
    }
    ...
    if (lua_isnumber(L, 4))
    {
        ...
        if (expiryCount < 1)
        {
            ...
            lua_pushfstring(
                L,
                "tempColorTrigger: bad argument #4 value (trigger expiration count must be greater than zero, got %d)",
                expiryCount);
            return 2;
        }
    }
    ...
    if (lua_isstring(L, 3))
    {
        triggerID = pLuaInterpreter->startTempColorTrigger(foregroundColor, backgroundColor,
                                                           QString::fromUtf8(lua_tostring(L, 3)), expiryCount);
    }
    ...
    {
        lua_pushfstring(
            L, "tempColorTrigger: bad argument #3 type (code to run as a string or a function expected, got %s!)",
            luaL_typename(L, 3));
        return lua_error(L);
    }
...
int TLuaInterpreter::tempAnsiColorTrigger(lua_State *L)
{
    ...
    {
        lua_pushfstring(
            L, "tempAnsiColorTrigger: bad argument #1 type (code to run as a string or a function expected, got %s!)",
            luaL_typename(L, 1));
        return lua_error(L);
    }
    ...
    {
        lua_pushfstring(L,
                        "tempAnsiColorTrigger: bad argument #2 type (foreground color as ANSI Color number {%d = "
                        "ignore foreground color, %d = default colour, 0 to 255 ANSI colour} expected, got %s!)",
    ...
    else
    {
        ...
        if (!(value == TTrigger::scmIgnored || value == TTrigger::scmDefault || (value >= 0 && value <= 255)))
        {
            lua_pushnil(L);
            lua_pushfstring(L,
                            "invalid ANSI color number %d, currently only %d (ignore foreground color), %d (default "
                            "foregroud colour) or 0 to 255 recognised",
        ...
        else if (value == TTrigger::scmIgnored && lua_gettop(L) < 2)
        {
            lua_pushnil(L);
            lua_pushfstring(L,
                            "invalid ANSI color number %d, it cannot be used (to ignore the foreground color) if the "
                            "background color is ommitted",
                            value);
        }
        else
        {
    ...
    {
        lua_pushfstring(L,
                        "tempAnsiColorTrigger: bad argument #3 type (background color as ANSI Color number {%d = "
                        "ignore foreground color, %d = default colour, 0 to 255 ANSI colour} expected, got %s!)",
    ...
    else
    {
        ...
        if (!(value == TTrigger::scmIgnored || value == TTrigger::scmDefault || (value >= 0 && value <= 255)))
        {
            lua_pushnil(L);
            lua_pushfstring(L,
                            "invalid ANSI color number %d, currently only %d (ignore background color), %d (default "
                            "background color) or 0 to 255 recognised",
                            value, TTrigger::scmIgnored, TTrigger::scmDefault);
        }
        else if (value == TTrigger::scmIgnored && ansiFgColor == TTrigger::scmIgnored)
        {
            lua_pushnil(L);
            lua_pushfstring(L,
                            "invalid ANSI color number %d, it cannot be used for the background color (to ignore that) "
                            "if the foreground is also set to that value to also be ignored",
                            value);
        }
        else
        {
...
int TLuaInterpreter::tempLineTrigger(lua_State *L)
{
    ...
    {
        lua_pushfstring(
            L, "tempLineTrigger: bad argument #1 type (line to start matching from as number expected, got %s!)",
            luaL_typename(L, 1));
        return lua_error(L);
    }
    ...
    {
        lua_pushfstring(
            L, "tempLineTrigger: bad argument #2 type (how many lines to match for as number expected, got %s!)",
            luaL_typename(L, 2));
        return lua_error(L);
    }
    ...
    if (lua_isnumber(L, 4))
    {
        ...
        if (expiryCount < 1)
        {
            ...
            lua_pushfstring(
                L,
                "tempLineTrigger: bad argument #4 value (trigger expiration count must be greater than zero, got %d)",
                expiryCount);
            return 2;
        }
    }
    ...
    {
        triggerID =
            pLuaInterpreter->startTempLineTrigger(from, howMany, QString::fromUtf8(lua_tostring(L, 3)), expiryCount);
    }
    else if (lua_isfunction(L, 3))
    {
    ...
    {
        lua_pushfstring(
            L, "tempLineTrigger: bad argument #3 type (code to run as a string or a function expected, got %s!)",
            luaL_typename(L, 3));
        return lua_error(L);
    }
...
int TLuaInterpreter::tempComplexRegexTrigger(lua_State *L)
{
    ...
    if (!lua_isstring(L, 1))
    {
        lua_pushfstring(
            L,
            "tempComplexRegexTrigger: bad argument #1 type (trigger name create or add to as string expected, got %s!)",
            luaL_typename(L, 1));
        return lua_error(L);
    }
    else if (!lua_isstring(L, 2))
    {
        lua_pushfstring(L, "tempComplexRegexTrigger: bad argument #2 type (regex pattern to match as string, got %s!)",
                        luaL_typename(L, 2));
        return lua_error(L);
    }
    else if (!lua_isstring(L, 3) && !lua_isfunction(L, 3))
    {
        lua_pushfstring(
            L,
            "tempComplexRegexTrigger: bad argument #3 type (code to run as a string or a function expected, got %s!)",
            luaL_typename(L, 3));
        return lua_error(L);
    }
    else if (!lua_isnumber(L, 4))
    {
        lua_pushfstring(L, "tempComplexRegexTrigger: bad argument #4 type (multiline flag as number expected, got %s!)",
                        luaL_typename(L, 4));
        return lua_error(L);
    }
    else if (!lua_isnumber(L, 7))
    {
        lua_pushfstring(L, "tempComplexRegexTrigger: bad argument #7 type (filter flag as number expected, got %s!)",
                        luaL_typename(L, 7));
        return lua_error(L);
    }
    else if (!lua_isnumber(L, 8))
    {
        lua_pushfstring(L, "tempComplexRegexTrigger: bad argument #8 type (match all flag as number expected, got %s!)",
                        luaL_typename(L, 8));
        return lua_error(L);
    }
    else if (!lua_isnumber(L, 12))
    {
        lua_pushfstring(L, "tempComplexRegexTrigger: bad argument #12 type (fire length as number expected, got %s!)",
                        luaL_typename(L, 12));
        return lua_error(L);
    }
    else if (!lua_isnumber(L, 13))
    {
        lua_pushfstring(L, "tempComplexRegexTrigger: bad argument #13 type (line delta as number expected, got %s!)",
                        luaL_typename(L, 13));
        return lua_error(L);
    }
    ...
    if (lua_isnumber(L, 14))
    {
        ...
        {
            lua_pushfstring(L,
                            "tempComplexRegexTrigger: bad argument #14 value (trigger expiration count must be greater "
                            "than zero, got %d)",
                            expiryCount);
            return lua_error(L);
        }
...
int TLuaInterpreter::setButtonStyleSheet(lua_State *L)
{
    ...
    if (!lua_isstring(L, 1))
    {
        lua_pushfstring(L, "setButtonStyleSheet: bad argument #1 type (name as string expected, got %s!)",
                        luaL_typename(L, 1));
        return lua_error(L);
    }
    else
    ...
    if (!lua_isstring(L, 2))
    {
        lua_pushfstring(L, "setButtonStyleSheet: bad argument #2 type (css as string expected, got %s!)",
                        luaL_typename(L, 2));
        return lua_error(L);
    }
    else
...
int TLuaInterpreter::tempRegexTrigger(lua_State *L)
{
    ...
    if (!lua_isstring(L, 1))
    {
        lua_pushfstring(L, "tempRegexTrigger: bad argument #1 type (regex pattern as string expected, got %s!)",
                        luaL_typename(L, 1));
        return lua_error(L);
    }
    ...
    if (lua_isnumber(L, 3))
    {
        ...
        if (expiryCount < 1)
        {
            ...
            lua_pushfstring(
                L,
                "tempRegexTrigger: bad argument #3 value (trigger expiration count must be greater than zero, got %d)",
                expiryCount);
            return 2;
        }
    }
    ...
    {
        triggerID =
            pLuaInterpreter->startTempRegexTrigger(regexPattern, QString::fromUtf8(lua_tostring(L, 2)), expiryCount);
    }
    else if (lua_isfunction(L, 2))
    {
    ...
    {
        lua_pushfstring(
            L, "tempRegexTrigger: bad argument #2 type (code to run as a string or a function expected, got %s!)",
            luaL_typename(L, 2));
        return lua_error(L);
    }
...
int TLuaInterpreter::isActive(lua_State *L)
{
    ...
    else
    {
        ...
        lua_pushfstring(
            L,
            "invalid type '%s' given, it should be one (case insensitive) of: 'alias', 'keybind', 'timer' or 'trigger'",
...
int TLuaInterpreter::getScript(lua_State *L)
{
    ...
    if (!lua_isstring(L, 1))
    {
        lua_pushfstring(L, "getScript: bad argument #1 type (script name as string expected, got %s!)",
                        luaL_typename(L, 1));
        return lua_error(L);
    }
    QString name = QString::fromUtf8(lua_tostring(L, 1));
    ...
    if (n > 1)
    {
        if (!lua_isnumber(L, 2))
        {
            lua_pushfstring(L, "getScript: bad argument #2 type (script position as number expected, got %s!)",
                            luaL_typename(L, 2));
            return lua_error(L);
        }
    ...
    if (!pS)
    {
        lua_pushnumber(L, -1);
        lua_pushstring(
            L, QStringLiteral("script \"%1\" at position \"%2\" not found").arg(name).arg(++pos).toUtf8().constData());
        return 2;
    }
...
int TLuaInterpreter::setScript(lua_State *L)
{
    ...
    if (!lua_isstring(L, 1))
    {
        lua_pushfstring(L, "setScript: bad argument #1 type (script name as string expected, got %s!)",
                        luaL_typename(L, 1));
        return lua_error(L);
    }
    QString name = QString::fromUtf8(lua_tostring(L, 1));
    ...
    if (!lua_isstring(L, 2))
    {
        lua_pushfstring(L, "setScript: bad argument #2 type (script lua code as string expected, got %s!)",
                        luaL_typename(L, 2));
        return lua_error(L);
    }
    QString luaCode = QString::fromUtf8(lua_tostring(L, 2));
    ...
    if (n > 2)
    {
        if (!lua_isnumber(L, 3))
        {
            lua_pushfstring(L, "setScript: bad argument #3 type (script position as number expected, got %s!)",
                            luaL_typename(L, 3));
            return lua_error(L);
        }
...
int TLuaInterpreter::permScript(lua_State *L)
{
    if (!lua_isstring(L, 1))
    {
        lua_pushfstring(L, "permScript: bad argument #1 type (script name as string expected, got %s!)",
                        luaL_typename(L, 1));
        return lua_error(L);
    }
    QString name = QString::fromUtf8(lua_tostring(L, 1));
    ...
    if (!lua_isstring(L, 2))
    {
        lua_pushfstring(L, "permScript: bad argument #2 type (script parent name as string expected, got %s!)",
                        luaL_typename(L, 2));
        return lua_error(L);
    }
    QString parent = QString::fromUtf8(lua_tostring(L, 2));
    ...
    if (!lua_isstring(L, 3))
    {
        lua_pushfstring(L, "permScript: bad argument #3 type (script as string expected, got %s!)",
                        luaL_typename(L, 3));
        return lua_error(L);
    }
...
int TLuaInterpreter::permTimer(lua_State *L)
{
    if (!lua_isstring(L, 1))
    {
        lua_pushfstring(L, "permTimer: bad argument #1 type (timer name as string expected, got %s!)",
                        luaL_typename(L, 1));
        return lua_error(L);
    }
    QString name = QString::fromUtf8(lua_tostring(L, 1));
    ...
    if (!lua_isstring(L, 2))
    {
        lua_pushfstring(L, "permTimer: bad argument #2 type (timer parent name as string expected, got %s!)",
                        luaL_typename(L, 2));
        return lua_error(L);
    }
    QString parent = QString::fromUtf8(lua_tostring(L, 2));
    ...
    {
        lua_pushfstring(L,
                        "permTimer: bad argument #3 type (time in seconds as {maybe decimal} number expected, got %s!)",
                        luaL_typename(L, 3));
        return lua_error(L);
    }
...
int TLuaInterpreter::permPromptTrigger(lua_State *L)
{
    ...
    if (!lua_isstring(L, 1))
    {
        lua_pushfstring(L, "permPromptTrigger: bad argument #1 type (trigger name as string expected, got %s!)",
                        luaL_typename(L, 1));
        return lua_error(L);
    }
    ...
    if (!lua_isstring(L, 2))
    {
        lua_pushfstring(L, "permPromptTrigger: bad argument #2 type (parent trigger name as string expected, got %s!)",
                        luaL_typename(L, 2));
        return lua_error(L);
    }
    ...
    if (!lua_isstring(L, 3))
    {
        lua_pushfstring(L, "permPromptTrigger: bad argument #3 type (code to run as string expected, got %s!)",
                        luaL_typename(L, 3));
        return lua_error(L);
    }
...
int TLuaInterpreter::permKey(lua_State *L)
{
    ...
    if (lua_gettop(L) > 4)
    {
        ...
        {
            lua_pushfstring(L, "permKey: bad argument #%d type (key modifier as number is optional, got %s!)", argIndex,
                            luaL_typename(L, argIndex));
            return lua_error(L);
        }
        else
    ...
    {
        lua_pushfstring(L, "permKey: bad argument #%d type (key code as number expected, got %s!)", argIndex,
                        luaL_typename(L, argIndex));
        return lua_error(L);
    }
    else
    ...
    if (!lua_isstring(L, ++argIndex))
    {
        lua_pushfstring(L, "permKey: bad argument #%d type (lua script as string expected, got %s!)", argIndex,
                        luaL_typename(L, argIndex));
        return lua_error(L);
    }
    else
    ...
    Host &host = getHostFromLua(L);
    TLuaInterpreter *pLuaInterpreter = host.getLuaInterpreter();
    // FIXME: The script in the luaFunction could fail to compile - although this will still create a key (which will
    // error each time it is encountered)
...
int TLuaInterpreter::tempKey(lua_State *L)
{
    ...
    if (lua_gettop(L) > 2)
    {
        if (!lua_isnumber(L, ++argIndex) && !lua_isnil(L, argIndex))
        {
            lua_pushfstring(L, "tempKey: bad argument #%d type (key modifier as number is optional, got %s!)", argIndex,
                            luaL_typename(L, argIndex));
            return lua_error(L);
        }
        else
    ...
    if (!lua_isnumber(L, ++argIndex))
    {
        lua_pushfstring(L, "tempKey: bad argument #%d type (key code as number expected, got %s!)", argIndex,
                        luaL_typename(L, argIndex));
        return lua_error(L);
    }
    else
    ...
    if (!lua_isstring(L, ++argIndex))
    {
        lua_pushfstring(L, "tempKey: bad argument #%d type (lua script as string expected, got %s!)", argIndex,
                        luaL_typename(L, argIndex));
        return lua_error(L);
    }
    else
...
int TLuaInterpreter::permBeginOfLineStringTrigger(lua_State *L)
{
    ...
    {
        lua_pushfstring(L,
                        "permBeginOfLineStringTrigger: bad argument #1 type (trigger name as string expected, got %s!)",
                        luaL_typename(L, 1));
        return lua_error(L);
    }
    QString name = QString::fromUtf8(lua_tostring(L, 1));
    ...
    {
        lua_pushfstring(
            L, "permBeginOfLineStringTrigger: bad argument #2 type (trigger parent as string expected, got %s!)",
            luaL_typename(L, 2));
        return lua_error(L);
    }
    QString parent = QString::fromUtf8(lua_tostring(L, 2));
    ...
    {
        lua_pushfstring(
            L, "permBeginOfLineStringTrigger: bad argument #3 type (sub-strings list as table expected, got %s!)",
            luaL_typename(L, 3));
        return lua_error(L);
    }
    lua_pushnil(L);
    ...
    {
        lua_pushfstring(L,
                        "permBeginOfLineStringTrigger: bad argument #4 type (lua script as string expected, got %s!)",
                        luaL_typename(L, 4));
        return lua_error(L);
    }
    QString script = QString::fromUtf8(lua_tostring(L, 4));
...
int TLuaInterpreter::getTimestamp(lua_State *L)
{
    ...
    if (n > 1)
    {
        ...
        {
            lua_pushfstring(L,
                            "getTimestamp: bad argument #%d type (mini console, user window or buffer name as string "
                            "expected {may be omitted for the \"main\" console}, got %s!)",
                            s, luaL_typename(L, s));
            return lua_error(L);
        }
    ...
    if (!lua_isnumber(L, ++s))
    {
        lua_pushfstring(L, "getTimestamp: bad argument #%d type (line number as number expected, got %s!", s,
                        luaL_typename(L, s));
        return lua_error(L);
    }
    else
...
int TLuaInterpreter::setAreaName(lua_State *L)
{
    ...
    else if (host.mpMap->mpRoomDB->getAreaNamesMap().values().count(newName) > 0)
    {
        ...
        if (host.mpMap->mpRoomDB->getAreaNamesMap().value(id) != newName)
        {
            ...
            lua_pushfstring(L,
                            ...
                            host.mpMap->mpRoomDB->getAreaNamesMap().key(newName), newName.toUtf8().constData());
            return 2;
        }
        else
        {
    ...
    {
        if (id > 0 &&
            host.mpMap->mpRoomDB->getAreaNamesMap().value(id) == host.mpMap->mpMapper->showArea->currentText())
        {
...
int TLuaInterpreter::addAreaName(lua_State *L)
{
    ...
    else if (host.mpMap->mpRoomDB->getAreaNamesMap().values().count(name) > 0)
    {
        ...
        lua_pushfstring(L,
                        ...
                        "id %d already has the name \"%s\").",
                        host.mpMap->mpRoomDB->getAreaNamesMap().key(name), name.toUtf8().constData());
        return 2;
    }
...
int TLuaInterpreter::deleteArea(lua_State *L)
{
    ...
    if (lua_isnumber(L, 1))
    {
        ...
        if (id < 1)
        {
            ...
            return 2;
                 ...
                 !host.mpMap->mpRoomDB->getAreaNamesMap().contains(id))
        {
            lua_pushnil(L);
    ...
    else if (lua_isstring(L, 1))
    {
        ...
        {
            lua_pushnil(L);
            lua_pushfstring(L, "deleteArea: bad argument #1 value (you can't delete the default area).");
            return 2;
        }
    }
    else
...
int TLuaInterpreter::createMapLabel(lua_State *L)
{
    ...
    lua_pushinteger(
        L, host.mpMap->createMapLabel(area, _text, posx, posy, posz, fg, bg, showOnTop, noScaling, zoom, fontSize));
    return 1;
}
...
int TLuaInterpreter::createMapImageLabel(lua_State *L)
{
    ...
    Host &host = getHostFromLua(L);
    lua_pushinteger(
        L, host.mpMap->createMapImageLabel(area, _text, posx, posy, posz, width, height, zoom, showOnTop, false));
    return 1;
}
...
int TLuaInterpreter::setDoor(lua_State *L)
{
    ...
    else
    {
        ...
        if (exitCmd.compare(QStringLiteral("n")) && exitCmd.compare(QStringLiteral("e")) &&
            exitCmd.compare(QStringLiteral("s")) && exitCmd.compare(QStringLiteral("w")) &&
            exitCmd.compare(QStringLiteral("ne")) && exitCmd.compare(QStringLiteral("se")) &&
            exitCmd.compare(QStringLiteral("sw")) && exitCmd.compare(QStringLiteral("nw")) &&
            exitCmd.compare(QStringLiteral("up")) && exitCmd.compare(QStringLiteral("down")) &&
            exitCmd.compare(QStringLiteral("in")) && exitCmd.compare(QStringLiteral("out")))
        {
        ...
        else
        {
            ...
            if (!(((!exitCmd.compare(QStringLiteral("n"))) &&
                   (pR->getExit(DIR_NORTH) > 0 || pR->exitStubs.contains(DIR_NORTH))) ||
                  ((!exitCmd.compare(QStringLiteral("e"))) &&
                   (pR->getExit(DIR_EAST) > 0 || pR->exitStubs.contains(DIR_EAST))) ||
                  ((!exitCmd.compare(QStringLiteral("s"))) &&
                   (pR->getExit(DIR_SOUTH) > 0 || pR->exitStubs.contains(DIR_SOUTH))) ||
                  ((!exitCmd.compare(QStringLiteral("w"))) &&
                   (pR->getExit(DIR_WEST) > 0 || pR->exitStubs.contains(DIR_WEST))) ||
                  ((!exitCmd.compare(QStringLiteral("ne"))) &&
                   (pR->getExit(DIR_NORTHEAST) > 0 || pR->exitStubs.contains(DIR_NORTHEAST))) ||
                  ((!exitCmd.compare(QStringLiteral("se"))) &&
                   (pR->getExit(DIR_SOUTHEAST) > 0 || pR->exitStubs.contains(DIR_SOUTHEAST))) ||
                  ((!exitCmd.compare(QStringLiteral("sw"))) &&
                   (pR->getExit(DIR_SOUTHWEST) > 0 || pR->exitStubs.contains(DIR_SOUTHWEST))) ||
                  ((!exitCmd.compare(QStringLiteral("nw"))) &&
                   (pR->getExit(DIR_NORTHWEST) > 0 || pR->exitStubs.contains(DIR_NORTHWEST))) ||
                  ((!exitCmd.compare(QStringLiteral("up"))) &&
                   (pR->getExit(DIR_UP) > 0 || pR->exitStubs.contains(DIR_UP))) ||
                  ((!exitCmd.compare(QStringLiteral("down"))) &&
                   (pR->getExit(DIR_DOWN) > 0 || pR->exitStubs.contains(DIR_DOWN))) ||
                  ((!exitCmd.compare(QStringLiteral("in"))) &&
                   (pR->getExit(DIR_IN) > 0 || pR->exitStubs.contains(DIR_IN))) ||
                  ((!exitCmd.compare(QStringLiteral("out"))) &&
                   (pR->getExit(DIR_OUT) > 0 || pR->exitStubs.contains(DIR_OUT)))))
            {
...
int TLuaInterpreter::setExitWeight(lua_State *L)
{
    ...
    if (!lua_isnumber(L, 1))
    {
        lua_pushfstring(L, "setExitWeight: bad argument #1 type (room id as number expected, got %s!)",
                        luaL_typename(L, 1));
        return lua_error(L);
    }
    else
    ...
    {
        lua_pushfstring(L,
                        "setExitWeight: bad argument #2 type (direction as string or number {between 1 and 12 "
                        "inclusive} expected, got %s!)",
                        luaL_typename(L, 2));
        return lua_error(L);
    }
    else
    {
        ...
        {
            lua_pushnil(L);
            lua_pushfstring(L, "room id %d does not have an exit that can be identified from \"%s\"", roomID,
                            lua_tostring(L, 2));
            return 2;
        }
    }
    ...
    if (!lua_isnumber(L, 3))
    {
        lua_pushfstring(L, "setExitWeight: bad argument #3 type (exit weight as number expected, got %s!)",
                        luaL_typename(L, 3));
        return lua_error(L);
    }
    else
    {
        ...
        if (weight < 0 || weight > std::numeric_limits<int>::max())
        {
            lua_pushnil(L);
            lua_pushfstring(L,
                            "weight %d is outside of the usable range of 0 (which resets the weight back to that of "
                            "the destination room) to %d",
...
int TLuaInterpreter::addCustomLine(lua_State *L)
{
    ...
    if (!lua_isnumber(L, 1))
    {
        lua_pushfstring(L, "addCustomLine: bad argument #1 type (room id as number expected, got %s!)",
                        luaL_typename(L, 1));
        return lua_error(L);
    }
    else
    ...
    {
        lua_pushfstring(L,
                        "addCustomLine: bad argument #2 type (target room id as number or coordinate list as table "
                        "expected, got %s!)",
                        luaL_typename(L, 2));
        return lua_error(L);
    }
    else if (lua_isnumber(L, 2))
    {
        ...
        else
        {
            ...
            if (area != area_to)
            {
                lua_pushnil(L);
                lua_pushfstring(L,
                                "target room is in area \"%s\" (id: %d) which is not the one \"%s\" (id: %d) in which "
                                "this custom line is to be drawn",
    ...
    else if (lua_istable(L, 2))
    {
        ...
        while (lua_next(L, 2) != 0)
        {
            ...
            {
                lua_pushfstring(L,
                                "addCustomLine: bad argument #2 table item index #%d type (coordinate list must be a "
                                "table containing tables of three coordinates, got %s as indicated item!)",
                                i, luaL_typename(L, -1));
                return lua_error(L);
            }
            lua_pushnil(L);
            ...
            while (lua_next(L, -2) != 0)
            {
                ...
                if (j <= 3)
                {
                    if (lua_type(L, -1) != LUA_TNUMBER)
                    {
                        ...
                        lua_pushfstring(L,
                                        "addCustomLine: bad argument #2 table item index #%d inner table item #%d type "
                                        "(coordinates list as table containing tables of three numbers (x, y and z "
                                        "coordinates} expected, but got a %s as the %c-coordinate at that index!)",
                                        i, j, luaL_typename(L, -1), coordinate);
                        return lua_error(L);
                    }
                    else
                    {
    ...
    {
        lua_pushfstring(L,
                        "addCustomLine: bad argument #3 type (direction as string or number (between 1 and 12 "
                        "inclusive) expected, got %s!)",
                        luaL_typename(L, 3));
        return lua_error(L);
    }
    else
    {
        ...
        {
            lua_pushnil(L);
            lua_pushfstring(L, "room id %d does not have an exit that can be identified from \"%s\"", id_from,
                            lua_tostring(L, 3));
            return 2;
        }
    }
    ...
    else
    {
        ...
        else
        {
            lua_pushnil(L);
            lua_pushfstring(L,
                            "invalid line style \"%s\", only use one of: \"solid line\", \"dot line\", \"dash line\", "
                            "\"dash dot line\" or \"dash dot dot line\"",
    ...
    else
    {
        ...
        while (lua_next(L, 5) != 0)
        {
            if (++tind <= 3)
            {
                ...
                {
                    lua_pushfstring(L,
                                    "addCustomLine: bad argument #4 table item #%d type (%s color component as a "
                                    "number between 0 and 255 expected, got %s!)",
                ...
                if (component < 0 || component > 255)
                {
                    lua_pushnil(L);
                    lua_pushfstring(L,
                                    "%s color component in the table of the fourth argument is %d which is out of the "
    ...
    for (int i = 1, total = z.size(); i < total; ++i)
    {
        ...
        {
            lua_pushnil(L);
            lua_pushfstring(L, "the z values are not all on the same level (first wrong value is %d at index %d)",
                            z.at(i), i + 1);
            return 2;
        }
...
int TLuaInterpreter::removeCustomLine(lua_State *L)
{
    ...
    if (!lua_isnumber(L, 1))
    {
        lua_pushfstring(L, "removeCustomLine: bad argument #1 type (room id as number expected, got %s!)",
                        luaL_typename(L, 1));
        return lua_error(L);
    }
    else
    ...
    {
        lua_pushfstring(L,
                        "removeCustomLine: bad argument #2 type (direction as string or number (between 1 and 12 "
                        "inclusive) expected, got %s!)",
                        luaL_typename(L, 2));
        return lua_error(L);
    }
    ...
    if ((pR->customLines.remove(direction) + pR->customLinesArrow.remove(direction) +
         pR->customLinesStyle.remove(direction) + pR->customLinesColor.remove(direction)) > 0)
    {
        // Need to update the TRoom {min|max}_{x|y} settings as they are used during
    ...
    {
        lua_pushnil(L);
        lua_pushfstring(L, "room id %d does not appear to have a custom exit line for the exit indentifed from  \"%s\"",
                        roomId, lua_tostring(L, 2));
        return 2;
    }
}
...
int TLuaInterpreter::getCustomLines(lua_State *L)
{
    ...
    if (!lua_isnumber(L, 1))
    {
        lua_pushfstring(L, "getCustomLines: bad argument #1 type (room id as number expected, got %s!)",
                        luaL_typename(L, 1));
        return lua_error(L);
    }
    else
    ...
    else
    {
        ...
        else
        {
            ...
            else
            {
                lua_pushnil(L);
                lua_pushfstring(
                    L, R"(getRoomUserData: bad argument #2 value (no user data with key:"%s" in room with id: %d).)",
...
int TLuaInterpreter::setMapUserData(lua_State *L)
{
    ...
    else
    {
        ...
        if (key.isEmpty())
        {
            lua_pushnil(L);
            lua_pushfstring(L,
                            R"(setMapUserData: bad argument #1 value ("key" is not allowed to be an empty string).)");
            return 2;
        }
    }
...
int TLuaInterpreter::downloadFile(lua_State *L)
{
    ...
    if (mudlet::debugMode)
    {
        TDebug(QColor(Qt::white), QColor(Qt::blue))
                << "downloadFile: script is downloading from " << reply->url().toString() << "\n" >>
            0;
    }
...
int TLuaInterpreter::setRoomArea(lua_State *L)
{
    ...
    if (lua_isnumber(L, 2))
    {
        ...
        else if (!host.mpMap->mpRoomDB->getAreaNamesMap().contains(areaId))
        {
            lua_pushnil(L);
            lua_pushfstring(
                L, "setRoomArea: bad argument #2 value (number %d is not a valid area id as it does not exist).",
                areaId);
            return 2;
        }
    }
...
int TLuaInterpreter::getGridMode(lua_State *L)
{
    ...
    if (!lua_isnumber(L, 1))
    {
        lua_pushfstring(L, "getGridMode: bad argument #1 type (area id as number expected, got %s!)",
                        luaL_typename(L, 1));
        return lua_error(L);
    }
    else
...
int TLuaInterpreter::setFgColor(lua_State *L)
{
    ...
    if (n > 3)
    {
        if (!lua_isstring(L, ++s))
        {
            lua_pushfstring(L, "setFgColor: bad argument #%d type (window name as string expected, got %s!)", s,
                            luaL_typename(L, s));
            return lua_error(L);
        }
        else
    ...
    if (!lua_isnumber(L, ++s))
    {
        lua_pushfstring(L, "setFgColor: bad argument #%d type (red component value as number expected, got %s!)", s,
                        luaL_typename(L, s));
        return lua_error(L);
    }
    else
    ...
    if (!lua_isnumber(L, ++s))
    {
        lua_pushfstring(L, "setFgColor: bad argument #%d type (green component value as number expected, got %s!)", s,
                        luaL_typename(L, s));
        return lua_error(L);
    }
    else
    {
        ...
        {
            lua_pushnil(L);
            lua_pushfstring(L, "the color's green component value %d is outside of the valid range (0 to 255)",
                            luaGreen);
            return 2;
        }
    }
    ...
    if (!lua_isnumber(L, ++s))
    {
        lua_pushfstring(L, "setFgColor: bad argument #%d type (blue component value as number expected, got %s!)", s,
                        luaL_typename(L, s));
...
int TLuaInterpreter::setBgColor(lua_State *L)
{
    ...
    if (n > 3)
    {
        if (!lua_isstring(L, ++s))
        {
            lua_pushfstring(L, "setBgColor: bad argument #%d type (window name as string expected, got %s!)", s,
                            luaL_typename(L, s));
            return lua_error(L);
        }
        else
    ...
    if (!lua_isnumber(L, ++s))
    {
        lua_pushfstring(L, "setBgColor: bad argument #%d type (red component value as number expected, got %s!)", s,
                        luaL_typename(L, s));
        return lua_error(L);
    }
    else
    ...
    if (!lua_isnumber(L, ++s))
    {
        lua_pushfstring(L, "setBgColor: bad argument #%d type (green component value as number expected, got %s!)", s,
                        luaL_typename(L, s));
        lua_error(L);
        return lua_error(L);
    }
    ...
    if (!lua_isnumber(L, ++s))
    {
        lua_pushfstring(L, "setBgColor: bad argument #%d type (blue component value as number expected, got %s!)", s,
                        luaL_typename(L, s));
        return lua_error(L);
    }
    else
...
int TLuaInterpreter::insertText(lua_State *L)
{
    ...
    { // Have more than one argument so first must be a console name
        if (!lua_isstring(L, ++s))
        {
            lua_pushfstring(L, "insertText: bad argument #%d type (name as string expected, got %s!)", s,
                            luaL_typename(L, s));
            return lua_error(L);
        }
        else
    ...
    if (!lua_isstring(L, ++s))
    {
        lua_pushfstring(L, "insertText: bad argument #%d type (text as string expected, got %s!)", s,
                        luaL_typename(L, s));
        return lua_error(L);
    }
    else
...
int TLuaInterpreter::Echo(lua_State *L)
{
    ...
    if (!lua_isstring(L, n))
    {
        lua_pushfstring(L, "echo: bad argument #%d type (text to display as string expected, got %s!)", n,
                        luaL_typename(L, n));
        return lua_error(L);
    }
    else
    ...
    else
    {
        ...
        else
        {
            ...
            lua_pushfstring(
                L,
                R"(echo: bad argument #1 value (console name "%s" does not exist, omit this{or use the default "main"} to send text to main console!))",
...
int TLuaInterpreter::echoPopup(lua_State *L)
{
    ...
    if (n >= 4)
    {
        if (!lua_isstring(L, s))
        {
            lua_pushfstring(L, "echoPopup: bad argument #%d type (window name as string expected, got %s!)", s,
                            luaL_typename(L, s));
            return lua_error(L);
        }
        else
    ...
    if (!lua_isstring(L, s))
    {
        lua_pushfstring(L, "echoPopup: bad argument #%d type (text as string expected, got %s!)", s,
                        luaL_typename(L, s));
    }
    else
    {
    ...
    if (!lua_istable(L, s))
    {
        lua_pushfstring(L, "echoPopup: bad argument #%d type (command list as table expected, got %s!)", s,
                        luaL_typename(L, s));
        return lua_error(L);
    }
    else
    ...
    if (!lua_istable(L, s))
    {
        lua_pushfstring(L, "echoPopup: bad argument #%d type (hint list as table expected, got %s!)", s,
                        luaL_typename(L, s));
        return lua_error(L);
    }
    else
...
int TLuaInterpreter::echoLink(lua_State *L)
{
    ...
    if (!lua_isstring(L, ++s))
    {
        ...
        {
            lua_pushfstring(L, "echoLink: bad argument #%d type (text as string expected, got %s!)", s,
                            luaL_typename(L, s));
        }
        else
        {
            lua_pushfstring(L, "echoLink: bad argument #%d type (optional window name as string expected, got %s!)", s,
                            luaL_typename(L, s));
        }
        return lua_error(L);
    }
    ...
    if (n > 1)
    {
        if (!lua_isstring(L, ++s))
        {
            if (n == 3 || (n > 3 && n < 5 && gotBool))
            {
                lua_pushfstring(L, "echoLink: bad argument #%d type (command as string expected, got %s!)", s,
                                luaL_typename(L, s));
            }
            else
            {
    ...
    if (n > 2)
    {
        if (!lua_isstring(L, ++s))
        {
            if (n == 3 || (n > 3 && n < 5 && gotBool))
            {
                lua_pushfstring(L, "echoLink: bad argument #%d type (hint as string expected, got %s!)", s,
                                luaL_typename(L, s));
            }
            else
            {
    ...
    if (n > 3)
    {
        ...
        else
        {
            if (gotBool)
            {
                lua_pushfstring(L, "echoLink: bad argument #%d type (useCurrentFormat as boolean expected, got %s!)", s,
                                luaL_typename(L, s));
            }
            else
            {
...
int TLuaInterpreter::pasteWindow(lua_State *L)
{
    ...
    if (!lua_isstring(L, 1))
    {
        lua_pushfstring(L, "pasteWindow: bad argument #1 type (window name as string expected, got %s!)",
                        luaL_typename(L, 1));
        return lua_error(L);
    }
    else
        ...
        if (lua_isstring(L, 1))
        {
            ...
            if (!inputText.isEmpty())
            {
                ...
                if (numericEquivalent && isOk)
                {
                    ...
                    {
                        lua_pushnil(L);
                        lua_pushfstring(L, "%s does not appear to be a valid Discord application id",
                                        inputText.toUtf8().constData());
                        return 2;
                    }
                }
                else
                {
                    lua_pushnil(L);
                    lua_pushfstring(L, "%s can not be converted to the expected numeric Discord application id",
                                    inputText.toUtf8().constData());
                    return 2;
                }
            }
...
int TLuaInterpreter::setDiscordLargeIcon(lua_State *L)
{
    ...
    {
        lua_pushfstring(L, "setDiscordLargeIcon: bad argument #1 type (key as string expected, got %s!)",
                        luaL_typename(L, 1));
        return lua_error(L);
    }
}
...
int TLuaInterpreter::setDiscordLargeIconText(lua_State *L)
{
    ...
    {
        lua_pushfstring(L, "setDiscordLargeIconText: bad argument #%d type (text as string expected, got %s!)", 1,
                        luaL_typename(L, 1));
        return lua_error(L);
    }
}
...
int TLuaInterpreter::setDiscordSmallIcon(lua_State *L)
{
    ...
    {
        lua_pushfstring(L, "setDiscordSmallIcon: bad argument #%d type (key as string expected, got %s!)", 1,
                        luaL_typename(L, 1));
        return lua_error(L);
    }
}
...
int TLuaInterpreter::setDiscordSmallIconText(lua_State *L)
{
    ...
    {
        lua_pushfstring(L, "setDiscordSmallIconText: bad argument #%d type (text as string expected, got %s!)", 1,
                        luaL_typename(L, 1));
        return lua_error(L);
    }
}
...
int TLuaInterpreter::setDiscordDetail(lua_State *L)
{
    ...
    {
        lua_pushfstring(L, "setDiscordDetail: bad argument #%d type (text as string expected, got %s!)", 1,
                        luaL_typename(L, 1));
        return lua_error(L);
    }
}
...
int TLuaInterpreter::setDiscordGame(lua_State *L)
{
    ...
    {
        lua_pushfstring(L, "setDiscordGame: bad argument #%d type (game name as string expected, got %s!)", 1,
                        luaL_typename(L, 1));
        return lua_error(L);
    }
}
...
int TLuaInterpreter::setDiscordState(lua_State *L)
{
    ...
    {
        lua_pushfstring(L, "setDiscordState: bad argument #%d type (text as string expected, got %s!)", 1,
                        luaL_typename(L, 1));
        return lua_error(L);
    }
}
...
int TLuaInterpreter::setDiscordElapsedStartTime(lua_State *L)
{
    ...
    if (lua_isnumber(L, 1))
    {
        ...
        {
            lua_pushnil(L);
            lua_pushstring(L, "the timestamp must be zero to clear the \"elapsed:\" time or an epoch time value from "
                              "the recent past");
            return 2;
        }
    }
    ...
    {
        lua_pushfstring(L, "setDiscordElapsedStartTime: bad argument #%d type (epoch time as number, got %s!)", 1,
                        luaL_typename(L, 1));
        return lua_error(L);
    }
}
...
int TLuaInterpreter::setDiscordRemainingEndTime(lua_State *L)
{
    ...
    if (lua_isnumber(L, 1))
    {
        ...
        {
            lua_pushnil(L);
            lua_pushstring(L, "the timestamp must be zero to clear the \"remaining:\" time or an epoch time value in "
                              "the recent future");
            return 2;
        }
    }
    ...
    {
        lua_pushfstring(L, "setDiscordRemainingEndTime: bad argument #%d type (epoch time as number, got %s!)", 1,
                        luaL_typename(L, 1));
        return lua_error(L);
    }
}
...
int TLuaInterpreter::setDiscordParty(lua_State *L)
{
    ...
    {
        lua_pushfstring(L, "setDiscordParty: bad argument #%d type (current party size as number expected, got %s!)", 1,
                        luaL_typename(L, 1));
        return lua_error(L);
    }
    ...
    if (lua_gettop(L) > 1)
    {
        ...
        {
            lua_pushnil(L);
            lua_pushstring(L, "the optional party maximum size must be zero (to remove the party details) or more (to "
                              "set the maximum)");
            return 2;
        }
...
int TLuaInterpreter::getTime(lua_State *L)
{
    ...
    if (n > 0)
    {
        ...
        if (n > 1)
        {
            if (!lua_isstring(L, 2))
            {
                lua_pushfstring(L, "getTime: bad argument #2 (custom time format as string expected, got %s)",
                                luaL_typename(L, 2));
                return lua_error(L);
            }
            else
...
int TLuaInterpreter::appendCmdLine(lua_State *L)
{
    ...
    if (!lua_isstring(L, 1))
    {
        lua_pushfstring(L, "appendCmdLine: bad argument #1 (text to append as string expected, got %s)",
                        luaL_typename(L, 1));
        return lua_error(L);
    }
    else
...
int TLuaInterpreter::installPackage(lua_State *L)
{
    ...
    {
        lua_pushfstring(
            L, "installPackage: bad argument #1 (package location path and file name as string expected, got %s)",
            luaL_typename(L, 1));
        return lua_error(L);
    }
    else
...
int TLuaInterpreter::uninstallPackage(lua_State *L)
{
    ...
    if (!lua_isstring(L, 1))
    {
        lua_pushfstring(L, "uninstallPackage: bad argument #1 (package name as string expected, got %s)",
                        luaL_typename(L, 1));
        return lua_error(L);
    }
    else
...
int TLuaInterpreter::installModule(lua_State *L)
{
    ...
    if (!lua_isstring(L, 1))
    {
        lua_pushfstring(L, "installModule: bad argument #1 (module location as string expected, got %s)",
                        luaL_typename(L, 1));
        return lua_error(L);
    }
    else
...
int TLuaInterpreter::uninstallModule(lua_State *L)
{
    ...
    if (!lua_isstring(L, 1))
    {
        lua_pushfstring(L, "uninstallModule: bad argument #1 (module name as string expected, got %s)",
                        luaL_typename(L, 1));
        return lua_error(L);
    }
    else
...
int TLuaInterpreter::reloadModule(lua_State *L)
{
    ...
    if (!lua_isstring(L, 1))
    {
        lua_pushfstring(L, "reloadModule: bad argument #1 (module name as string expected, got %s)",
                        luaL_typename(L, 1));
        return lua_error(L);
    }
    else
...
int TLuaInterpreter::enableModuleSync(lua_State *L)
{
    if (!lua_isstring(L, 1))
    {
        lua_pushfstring(L, "enableModuleSync: bad argument #1 (module name as string expected, got %s)",
                        luaL_typename(L, 1));
        return lua_error(L);
    }
...
int TLuaInterpreter::disableModuleSync(lua_State *L)
{
    if (!lua_isstring(L, 1))
    {
        lua_pushfstring(L, "disableModuleSync: bad argument #1 (module name as string expected, got %s)",
                        luaL_typename(L, 1));
        return lua_error(L);
    }
    QString module{QString::fromUtf8(lua_tostring(L, 1))};
...
int TLuaInterpreter::getModuleSync(lua_State *L)
{
    if (!lua_isstring(L, 1))
    {
        lua_pushfstring(L, "getModuleSync: bad argument #1 (module name as string expected, got %s)",
                        luaL_typename(L, 1));
        return lua_error(L);
    }
    QString module{QString::fromUtf8(lua_tostring(L, 1))};
...
int TLuaInterpreter::setDefaultAreaVisible(lua_State *L)
{
    ...
    else
    {
        ...
        if (host.mpMap->mpMapper)
        {
            ...
            if ((!host.mpMap->mpMapper->getDefaultAreaShown()) && (isToShowDefaultArea) &&
                (host.mpMap->mpMapper->mp2dMap->mAreaID == -1))
            {
...
int TLuaInterpreter::registerAnonymousEventHandler(lua_State *L)
{
    ...
    if (!lua_isstring(L, 1))
    {
        lua_pushfstring(L, "registerAnonymousEventHandler: bad argument #1 (event name as string expected, got %s)",
                        luaL_typename(L, 1));
        return lua_error(L);
    }
    else
    ...
    if (!lua_isstring(L, 2))
    {
        lua_pushfstring(L, "registerAnonymousEventHandler: bad argument #2 (function name as string expected, got %s)",
                        luaL_typename(L, 1));
        return lua_error(L);
    }
    else
...
int TLuaInterpreter::expandAlias(lua_State *L)
{
    ...
    if (!lua_isstring(L, 1))
    {
        lua_pushfstring(L, "expandAlias: bad argument #1 type (text to parse as string expected, got %s!)",
                        luaL_typename(L, 1));
        return lua_error(L);
    }
    else
    ...
    if (lua_gettop(L) > 1)
    {
        ...
        {
            lua_pushfstring(L, "expandAlias: bad argument #2 type (echo as boolean is optional, got %s!)",
                            luaL_typename(L, 2));
            return lua_error(L);
        }
        else
...
int TLuaInterpreter::printCmdLine(lua_State *L)
{
    ...
    if (!lua_isstring(L, 1))
    {
        lua_pushfstring(L, "printCmdLine: bad argument #1 (text to set on command line as string expected, got %s)",
                        luaL_typename(L, 1));
        return lua_error(L);
    }
    else
...
int TLuaInterpreter::sendRaw(lua_State *L)
{
    ...
    if (lua_gettop(L) > 1)
    {
        if (!lua_isboolean(L, 2))
        {
            lua_pushfstring(L, "send: bad argument #2 type (showOnScreen as boolean expected, got %s)",
                            luaL_typename(L, 2));
            return lua_error(L);
        }
        else
...
int TLuaInterpreter::sendIrc(lua_State *L)
{
    ...
    if (!lua_isstring(L, 1))
    {
        lua_pushfstring(L, "sendIrc: bad argument #1 type (target as string expected, got %s!)",
    ...
    if (!lua_isstring(L, 2))
    {
        lua_pushfstring(L, "sendIrc: bad argument #2 type (message as string expected, got %s!)",
...
int TLuaInterpreter::setIrcNick(lua_State *L)
{
    ...
    if (!lua_isstring(L, 1))
    {
        lua_pushfstring(L, "setIrcNick: bad argument #1 type (nick as string expected, got %s!)",
                        lua_typename(L, lua_type(L, 1)));
        return lua_error(L);
    }
    else
...
int TLuaInterpreter::setIrcServer(lua_State *L)
{
    ...
    if (!lua_isstring(L, 1))
    {
        lua_pushfstring(L, "setIrcServer: bad argument #1 type (hostname as string expected, got %s!)",
                        lua_typename(L, lua_type(L, 1)));
        return lua_error(L);
    }
    else
    ...
    if (!lua_isnoneornil(L, 2))
    {
        ...
        {
            lua_pushfstring(
                L, "setIrcServer: bad argument #2 type (port number as number is optional {default = 6667}, got %s!)",
                lua_typename(L, lua_type(L, 2)));
            return lua_error(L);
        }
        else
...
int TLuaInterpreter::setIrcChannels(lua_State *L)
{
    ...
    if (!lua_istable(L, 1))
    {
        lua_pushfstring(L, "setIrcChannels: bad argument #1 type (channels as table expected, got %s!)",
                        lua_typename(L, lua_type(L, 1)));
        return lua_error(L);
    }
    else
    {
        ...
        while (lua_next(L, 1) != 0)
        {
            ...
            if (lua_type(L, -1) == LUA_TSTRING)
            {
                ...
                if (!c.isEmpty() && (c.startsWith(QLatin1String("#")) || c.startsWith(QLatin1String("&")) ||
                                     c.startsWith(QLatin1String("+"))))
                {
                    newchannels << c;
                }
            }
...
int TLuaInterpreter::ttsSpeak(lua_State *L)
{
    ...
    if (!lua_isstring(L, 1))
    {
        lua_pushfstring(L, "ttsSpeak: bad argument #%1 type (text to say as string expected, got %s!)",
                        luaL_typename(L, 1));
        lua_error(L);
        return 1;
    }
...
int TLuaInterpreter::ttsSetPitch(lua_State *L)
{
    ...
    if (!lua_isnumber(L, 1))
    {
        lua_pushfstring(L, "ttsSetPitch: bad argument #1 type (pitch as number expected, got %s!)",
                        luaL_typename(L, 1));
        lua_error(L);
        return 1;
    }
...
int TLuaInterpreter::ttsSetVolume(lua_State *L)
{
    ...
    if (!lua_isnumber(L, 1))
    {
        lua_pushfstring(L, "ttsSetVolume: bad argument #1 type (volume as number expected, got %s!)",
                        luaL_typename(L, 1));
        lua_error(L);
        return 1;
    }
...
int TLuaInterpreter::ttsSetVoiceByName(lua_State *L)
{
    ...
    if (!lua_isstring(L, 1))
    {
        lua_pushfstring(L, "ttsSetVoiceByName: bad argument #1 type (voice as string expected, got %s!)",
                        luaL_typename(L, 1));
        lua_error(L);
        return 1;
    }
...
int TLuaInterpreter::ttsSetVoiceByIndex(lua_State *L)
{
    ...
    if (!lua_isnumber(L, 1))
    {
        lua_pushfstring(L, "ttsSetVoiceByIndex: bad argument #1 type (voice as index number expected, got %s!)",
                        luaL_typename(L, 1));
        lua_error(L);
        return 1;
    }
...
int TLuaInterpreter::ttsQueue(lua_State *L)
{
    ...
    if (!lua_isstring(L, 1))
    {
        lua_pushfstring(L, "ttsQueueText: bad argument #1 type (input as string expected, got %s!)",
                        luaL_typename(L, 1));
        lua_error(L);
        return 1;
    }
    ...
    if (lua_gettop(L) > 1)
    {
        if (!lua_isnumber(L, 2))
        {
            lua_pushfstring(L, "ttsQueueText: bad argument #2 type (index as number expected, got %s!)",
                            luaL_typename(L, 1));
            lua_error(L);
            return 1;
        }
...
int TLuaInterpreter::ttsGetQueue(lua_State *L)
{
    ...
    if (lua_gettop(L) > 0)
    {
        if (!lua_isnumber(L, 1))
        {
            lua_pushfstring(L, "ttsGetQueue: bad argument #1 type (index as number expected, got %s!)",
                            luaL_typename(L, 1));
            lua_error(L);
            return 1;
        }
...
int TLuaInterpreter::ttsClearQueue(lua_State *L)
{
    ...
    if (lua_gettop(L) > 0)
    {
        if (!lua_isnumber(L, 1))
        {
            lua_pushfstring(L, "ttsClearQueue: bad argument #1 type (index as number expected, got %s!)",
                            luaL_typename(L, 1));
            lua_error(L);
            return 1;
        }
...
QString TLuaInterpreter::formatLuaCode(const QString &code)
{
    ...
    QString thing =
        QString(
            R"(return get_formatted_code(get_ast("%1"), {indent_chunk = '  ', right_margin = 100, max_text_width = 160, keep_comments = true}))")
            .arg(escapedCode);
...
bool TLuaInterpreter::compile(const QString &code, QString &errorMsg, const QString &name)
{
    ...
    int error =
        (luaL_loadbuffer(L, code.toUtf8().constData(), strlen(code.toUtf8().constData()), name.toUtf8().constData()) ||
         lua_pcall(L, 0, 0, 0));
...
std::pair<bool, QString> TLuaInterpreter::discordApiEnabled(lua_State *L, bool writeAccess)
{
    ...
    if (writeAccess && !pMudlet->mDiscord.discordUserIdMatch(&host))
    {
        return std::make_pair(false,
                              QStringLiteral("Discord API is read-only as you're logged in with a different account in "
                                             "Discord compared to the one you entered for this profile"));
    }
...
void TLuaInterpreter::signalMXPEvent(const QString &type, const QMap<QString, QString> &attrs,
...
void TLuaInterpreter::parseJSON(QString &key, const QString &string_data, const QString &protocol)
{
    ...
    if (lua_istable(L, -1))
    {
        // only merge tables (instead of replacing them) if the key has been registered as a need to merge key by the
        // user default is Char.Status only
    ...
    if (tokenList.size() == 3 && tokenList.at(0).toLower() == "ire" && tokenList.at(1).toLower() == "composer" &&
        tokenList.at(2).toLower() == "edit")
    {
        ...
        if (match.capturedStart() != -1)
        {
            ...
            QRegularExpression codeRegex(QStringLiteral(
                R"lit(\\n|\\t|\\"|\\\\|\\u[0-9a-cA-C][0-9a-fA-F]{3}|\\u[dD][0-7][0-9a-fA-F]{2}|\\u[efEF][0-9a-fA-F]{3}|\\u[dD][89abAB][0-9a-fA-F]{2}\\u[dD][c-fC-F][0-9a-fA-F]{2})lit"));
            // We are about to search for 8 escape code strings within the initial text that the game gave us, patterns
            // are: \n  \t  \"  \\ - new line, tab, quote, backslash Then there are three patterns for \uXXXX where XXXX
...
void TLuaInterpreter::setMatches(lua_State *L)
{
    if (!mCaptureGroupList.empty())
    {
        ...
        {
            // if( (*it).length() < 1 ) continue; //have empty capture groups to be undefined keys i.e.
            // machts[emptyCapGroupNumber] = nil otherwise it's = "" i.e. an empty string
            lua_pushnumber(L, i);
        ...
        if (error != 0)
        {
            ...
            for (int i = 1; i <= nbpossible_errors; i++)
            {
                ...
                if (lua_isstring(L, i))
                {
                    ...
                    {
                        TDebug(QColor(Qt::white), QColor(Qt::red))
                                << "LUA: ERROR running anonymous Lua function ERROR:" << e.c_str() >>
                            0;
                    }
                }
            }
...
bool TLuaInterpreter::call(const QString &function, const QString &mName, const bool muteDebugOutput)
{
    ...
    if (error != 0)
    {
        ...
        for (int i = 1; i <= nbpossible_errors; i++)
        {
            ...
            if (lua_isstring(L, i))
            {
                ...
                if (mudlet::debugMode)
                {
                    TDebug(QColor(Qt::white), QColor(Qt::red)) << "LUA ERROR: when running script " << mName << " ("
                                                               << function << "),\nreason: " << e.c_str() << "\n" >>
                        0;
                }
            }
    ...
    else
    {
        ...
        {
            TDebug(QColor(Qt::white), QColor(Qt::darkGreen))
                    << "LUA OK: script " << mName << " (" << function << ") ran without errors\n" >>
                0;
        }
    }
    lua_pop(L, lua_gettop(L));
    ...
    if (error != 0)
    {
        ...
        for (int i = 1; i <= nbpossible_errors; i++)
        {
            ...
            if (lua_isstring(L, i))
            {
                ...
                if (mudlet::debugMode)
                {
                    TDebug(QColor(Qt::white), QColor(Qt::red)) << "LUA: ERROR running script " << mName << " ("
                                                               << function << ") ERROR:" << e.c_str() << "\n" >>
                        0;
                }
            }
        }
...
void TLuaInterpreter::logError(std::string &e, const QString &name, const QString &function)
{
    ...
    {
        mpHost->mpEditorDialog->mpErrorConsole->print(QStringLiteral("[%1:]").arg(tr("ERROR")), QColor(Qt::blue),
                                                      QColor(Qt::black));
        mpHost->mpEditorDialog->mpErrorConsole->print(
            QStringLiteral(" %1:<%2> %3:<%4>\n")
                .arg(
                    tr("object", "object is the Mudlet alias/trigger/script, used in this sample message: "
                                 "object:<Alias1> function:<cure_me>"),
                    name,
                    tr("function",
                       "function is the Lua function, used in this sample message: object:<Alias1> function:<cure_me>"),
                    function),
            QColor(Qt::green), QColor(Qt::black));
        mpHost->mpEditorDialog->mpErrorConsole->print(QStringLiteral("        <%1>\n").arg(e.c_str()), QColor(Qt::red),
                                                      QColor(Qt::black));
    }
    ...
    if (mpHost->mEchoLuaErrors)
    {
        ...
        if (mpHost->mpConsole->buffer.size() > 0 &&
            !mpHost->mpConsole->buffer.lineBuffer.at(mpHost->mpConsole->buffer.lineBuffer.size() - 1).isEmpty())
        {
            mpHost->postMessage(QStringLiteral("\n"));
        }

        mpHost->postMessage(
            QStringLiteral("[  LUA  ] - %1: <%2> %3:<%4>\n<%5>")
                .arg(
                    tr("object", "object is the Mudlet alias/trigger/script, used in this sample message: "
                                 "object:<Alias1> function:<cure_me>"),
                    name,
...
bool TLuaInterpreter::callConditionFunction(std::string &function, const QString &mName)
{
    ...
    else
    {
        ...
        {
            TDebug(QColor(Qt::white), QColor(Qt::darkGreen))
                    << "LUA OK script " << mName << " (" << function.c_str() << ") ran without errors\n" >>
                0;
        }
    }
    ...
    if (returnValues > 0)
    {
        // Lua docs: Like all tests in Lua, lua_toboolean returns 1 for any Lua value different from false and nil;
        // otherwise it returns 0 This means trigger patterns don't have to strictly return true or false, as it is
        // accepted in Lua */
...
bool TLuaInterpreter::callEventHandler(const QString &function, const TEvent &pE)
{
    ...
    for (int i = 0; i < pE.mArgumentList.size(); i++)
    {
        ...
        default:
            qWarning(
                R"(TLuaInterpreter::callEventHandler("%s", TEvent) ERROR: Unhandled ARGUMENT_TYPE: %i encountered in argument %i.)",
                function.toUtf8().constData(), pE.mArgumentTypeList.at(i), i);
            lua_pushnil(L);
        }
    }
    ...
    if (error != 0)
    {
        ...
        for (int i = 1; i <= nbpossible_errors; i++)
        {
            ...
            if (lua_isstring(L, i))
            {
                ...
                {
                    TDebug(QColor(Qt::white), QColor(Qt::red))
                            << "LUA: ERROR running " << luaFunction << " ERROR:" << e.c_str() << "\n" >>
                        0;
                }
            }
        }
...
int TLuaInterpreter::putHTTP(lua_State *L)
{
    ...
    {
        lua_pushfstring(L, "putHTTP: bad argument #1 type (data to send as string expected, got %s!)",
                        luaL_typename(L, 1));
        return lua_error(L);
    }
    else if (lua_isstring(L, 1))
    ...
    if (!lua_isstring(L, 2))
    {
        lua_pushfstring(L, "putHTTP: bad argument #2 type (remote url as string expected, got %s!)",
                        luaL_typename(L, 2));
        return lua_error(L);
    }
    else
    ...
    else if (lua_istable(L, 3))
    {
        ...
        while (lua_next(L, 3) != 0)
        {
            ...
            {
                lua_pushfstring(L,
                                "putHTTP: bad argument #3 type (custom headers must be strings, got header: %s (should "
                                "be string) and value: %s (should be string))",
    ...
    {
        lua_pushfstring(L, "putHTTP: bad argument #4 type (file to send as string location expected, got %s!)",
                        luaL_typename(L, 4));
        return lua_error(L);
    }
    ...
    if (!fileLocation.isEmpty())
    {
        ...
        {
            lua_pushnil(L);
            lua_pushfstring(L, "couldn't open \"%s\", is the location correct and do you have permissions to it?",
                            fileLocation.toUtf8().constData());
            return 2;
        }
    ...
    host.updateProxySettings(host.mLuaInterpreter.mpFileDownloader);
    QNetworkReply *reply = host.mLuaInterpreter.mpFileDownloader->put(
        request, fileToUpload.isEmpty() ? dataToPost.toUtf8() : fileToUpload);

    if (mudlet::debugMode)
    {
        TDebug(QColor(Qt::white), QColor(Qt::blue))
                << "putHTTP: script is uploading data to " << reply->url().toString() << "\n" >>
            0;
    }
...
int TLuaInterpreter::postHTTP(lua_State *L)
{
    ...
    if (!lua_isstring(L, 1) && !lua_isstring(L, 4))
    {
        lua_pushfstring(L, "postHTTP: bad argument #1 type (data to send as string expected, got %s!)",
                        luaL_typename(L, 1));
        return lua_error(L);
    }
    else if (lua_isstring(L, 1))
    ...
    if (!lua_isstring(L, 2))
    {
        lua_pushfstring(L, "postHTTP: bad argument #2 type (remote url as string expected, got %s!)",
                        luaL_typename(L, 2));
        return lua_error(L);
    }
    else
    ...
    if (!lua_istable(L, 3) && !lua_isnoneornil(L, 3))
    {
        lua_pushfstring(L, "postHTTP: bad argument #3 type (headers as a table expected, got %s!)",
                        luaL_typename(L, 3));
        return lua_error(L);
    }
    else if (lua_istable(L, 3))
    {
        ...
        while (lua_next(L, 3) != 0)
        {
            ...
            {
                lua_pushfstring(L,
                                "postHTTP: bad argument #3 type (custom headers must be strings, got header: %s "
                                "(should be string) and value: %s (should be string))",
                                luaL_typename(L, -2), luaL_typename(L, -1));
                return lua_error(L);
            }
            // removes value, but keeps key for next iteration
    ...
    if (!lua_isstring(L, 4) && !lua_isnoneornil(L, 4))
    {
        lua_pushfstring(L, "postHTTP: bad argument #4 type (file to send as string location expected, got %s!)",
                        luaL_typename(L, 4));
        return lua_error(L);
    }
    else if (lua_isstring(L, 4))
    ...
    host.updateProxySettings(host.mLuaInterpreter.mpFileDownloader);
    QNetworkReply *reply = host.mLuaInterpreter.mpFileDownloader->post(
        request, fileToUpload.isEmpty() ? dataToPost.toUtf8() : fileToUpload);

    if (mudlet::debugMode)
    {
        TDebug(QColor(Qt::white), QColor(Qt::blue))
                << QStringLiteral("postHTTP: script is uploading data to %1\n").arg(reply->url().toString()) >>
            0;
    }
...
int TLuaInterpreter::deleteHTTP(lua_State *L)
{
    ...
    if (!lua_isstring(L, 1))
    {
        lua_pushfstring(L, "deleteHTTP: bad argument #1 type (remote url as string expected, got %s!)",
                        luaL_typename(L, 1));
        return lua_error(L);
    }
    else
    ...
    {
        lua_pushfstring(L, "postHTTP: bad argument #2 type (headers as a table expected, got %s!)",
                        luaL_typename(L, 2));
        return lua_error(L);
    }
    else if (lua_istable(L, 2))
    {
        ...
        while (lua_next(L, 2) != 0)
        {
            ...
            {
                lua_pushfstring(L,
                                "postHTTP: bad argument #2 type (custom headers must be strings, got header: %s "
                                "(should be string) and value: %s (should be string))",
                                luaL_typename(L, -2), luaL_typename(L, -1));
                return lua_error(L);
            }
    ...
    {
        TDebug(QColor(Qt::white), QColor(Qt::blue))
                << QStringLiteral("deleteHTTP: script is sending delete request for %1\n")
                       .arg(reply->url().toString()) >>
            0;
    }
...
int TLuaInterpreter::unzipAsync(lua_State *L)
{
    if (!lua_isstring(L, 1))
    {
        lua_pushfstring(L, "unzipAsync: bad argument #1 type (zip location as string expected, got %s!)",
                        luaL_typename(L, 1));
        return lua_error(L);
    }
    ...
    if (!lua_isstring(L, 2))
    {
        lua_pushfstring(L, "unzipAsync: bad argument #2 type (extract location as string expected, got %s!)",
                        luaL_typename(L, 2));
        return lua_error(L);
    }
    ...
    {
        lua_pushnil(L);
        lua_pushstring(L, "couldn't create temporary directory to extract the zip into");
        return 2;
    }
    ...
    {
        lua_pushnil(L);
        lua_pushstring(L, "couldn't create output directory to put the extracted files into");
        return 2;
    }
...
// Documentation: https://wiki.mudlet.org/w/Manual:Lua_Functions#handleWindowResizeEvent is using noop function publicly
// - compare initLuaGlobals()
...
bool TLuaInterpreter::loadLuaModule(QQueue<QString> &resultMsgsQueue, const QString &requirement,
                                    const QString &failureConsequence, const QString &description,
                                    const QString &luaModuleId)
{
    int error = luaL_dostring(
        pGlobalLua, QStringLiteral("%1require \"%2\"")
                        .arg(luaModuleId.isEmpty() ? QString() : QStringLiteral("%1 =").arg(luaModuleId), requirement)
                        .toUtf8()
                        .constData());
    if (error)
    {
    ...
    newMessageQueue.enqueue(
        tr("[  OK  ]  - Lua module %1 loaded.", "%1 is the name (may specify which variant) of the module.")
...
void TLuaInterpreter::initLuaGlobals()
{
    ...
    lua_settable(pGlobalLua, LUA_GLOBALSINDEX);
    lua_register(pGlobalLua, "showUnzipProgress",
                 TLuaInterpreter::showUnzipProgress); // internal function used by the package system NOT FOR USERS
    ...
    luaL_dostring(pGlobalLua, QStringLiteral("package.path = [[%1%2?.lua;%1%2?%2init.lua;]] .. package.path")
                                  .arg(nativeHomeDirectory, separator)
                                  .toUtf8()
                                  .constData());

    luaL_dostring(pGlobalLua, QStringLiteral("package.cpath = [[%1%2?;]] .. package.cpath")
                                  .arg(nativeHomeDirectory, separator)
                                  .toUtf8()
                                  .constData());
    ...
    luaL_dostring(pGlobalLua, "if jit then package.cpath = package.cpath .. "
                              "';/usr/lib/lua/5.1/?.so;/usr/lib/x86_64-linux-gnu/lua/5.1/?.so' end");

    // AppInstaller on Linux would like the search path to also be set to the current binary directory
    luaL_dostring(pGlobalLua, QString("package.cpath = package.cpath .. ';%1/lib/?.so'")
                                  .arg(QCoreApplication::applicationDirPath())
                                  .toUtf8()
                                  .constData());
#elif defined(Q_OS_MAC)
    // macOS app bundle would like the search path to also be set to the current binary directory
    luaL_dostring(pGlobalLua, QString("package.cpath = package.cpath .. ';%1/?.so'")
                                  .arg(QCoreApplication::applicationDirPath())
                                  .toUtf8()
                                  .constData());
    luaL_dostring(pGlobalLua, QString("package.path = package.path .. ';%1/?.lua'")
                                  .arg(QCoreApplication::applicationDirPath())
                                  .toUtf8()
                                  .constData());
#elif defined(Q_OS_WIN32)
    ...
    loadLuaModule(modLoadMessageQueue, QLatin1String("lfs"), tr("Probably will not be able to access Mudlet Lua code."),
                  QLatin1String("lfs (Lua File System)"));
     ...
     */
    bool loaded = loadLuaModule(modLoadMessageQueue, QLatin1String("brimworks.zip"), QString(),
                                QStringLiteral("lua-zip"), QStringLiteral("zip"));
    if (!loaded)
    {
    ...
    loadLuaModule(modLoadMessageQueue, QLatin1String("luasql.sqlite3"), tr("Database support will not be available."),
                  QLatin1String("sqlite3"), QLatin1String("luasql"));
    while (!modLoadMessageQueue.isEmpty())
    {
        mpHost->postMessage(modLoadMessageQueue.dequeue());
    }

    loaded = loadLuaModule(modLoadMessageQueue, QLatin1String("lua-utf8"), QString(), QLatin1String("lua-utf8"),
                           QLatin1String("utf8"));
    if (!loaded)
    {
    ...
    loadLuaModule(modLoadMessageQueue, QLatin1String("yajl"), tr("yajl.* Lua functions won't be available."), QString(),
                  QLatin1String("yajl"));
    while (!modLoadMessageQueue.isEmpty())
    {
        mpHost->postMessage(modLoadMessageQueue.dequeue());
...
void TLuaInterpreter::setupLanguageData()
{
    ...
    lua_pushstring(L, QCoreApplication::translate("directions", "north",
                                                  "Entering this direction will move the player in the game")
                          .toUtf8()
                          .constData());
    lua_setfield(L, -2, "north");
    lua_pushstring(
        L, QCoreApplication::translate("directions", "n", "Entering this direction will move the player in the game")
               .toUtf8()
               .constData());
    lua_setfield(L, -2, "n");
    lua_pushstring(
        L, QCoreApplication::translate("directions", "east", "Entering this direction will move the player in the game")
               .toUtf8()
               .constData());
    lua_setfield(L, -2, "east");
    lua_pushstring(
        L, QCoreApplication::translate("directions", "e", "Entering this direction will move the player in the game")
               .toUtf8()
               .constData());
    lua_setfield(L, -2, "s");
    lua_pushstring(L, QCoreApplication::translate("directions", "south",
                                                  "Entering this direction will move the player in the game")
                          .toUtf8()
                          .constData());
    lua_setfield(L, -2, "south");
    lua_pushstring(
        L, QCoreApplication::translate("directions", "s", "Entering this direction will move the player in the game")
               .toUtf8()
               .constData());
    lua_setfield(L, -2, "s");
    lua_pushstring(
        L, QCoreApplication::translate("directions", "west", "Entering this direction will move the player in the game")
               .toUtf8()
               .constData());
    lua_setfield(L, -2, "west");
    lua_pushstring(
        L, QCoreApplication::translate("directions", "w", "Entering this direction will move the player in the game")
               .toUtf8()
               .constData());
    lua_setfield(L, -2, "w");
    lua_pushstring(L, QCoreApplication::translate("directions", "northeast",
                                                  "Entering this direction will move the player in the game")
                          .toUtf8()
                          .constData());
    lua_setfield(L, -2, "northeast");
    lua_pushstring(
        L, QCoreApplication::translate("directions", "ne", "Entering this direction will move the player in the game")
               .toUtf8()
               .constData());
    lua_setfield(L, -2, "ne");
    lua_pushstring(L, QCoreApplication::translate("directions", "southeast",
                                                  "Entering this direction will move the player in the game")
                          .toUtf8()
                          .constData());
    lua_setfield(L, -2, "southeast");
    lua_pushstring(
        L, QCoreApplication::translate("directions", "se", "Entering this direction will move the player in the game")
               .toUtf8()
               .constData());
    lua_setfield(L, -2, "se");
    lua_pushstring(L, QCoreApplication::translate("directions", "southwest",
                                                  "Entering this direction will move the player in the game")
                          .toUtf8()
                          .constData());
    lua_setfield(L, -2, "southwest");
    lua_pushstring(
        L, QCoreApplication::translate("directions", "sw", "Entering this direction will move the player in the game")
               .toUtf8()
               .constData());
    lua_setfield(L, -2, "sw");
    lua_pushstring(L, QCoreApplication::translate("directions", "northwest",
                                                  "Entering this direction will move the player in the game")
                          .toUtf8()
                          .constData());
    lua_setfield(L, -2, "northwest");
    lua_pushstring(
        L, QCoreApplication::translate("directions", "nw", "Entering this direction will move the player in the game")
               .toUtf8()
               .constData());
    lua_setfield(L, -2, "nw");
    lua_pushstring(
        L, QCoreApplication::translate("directions", "in", "Entering this direction will move the player in the game")
               .toUtf8()
               .constData());
    lua_setfield(L, -2, "in");
    lua_pushstring(
        L, QCoreApplication::translate("directions", "i", "Entering this direction will move the player in the game")
               .toUtf8()
               .constData());
    lua_setfield(L, -2, "i");
    lua_pushstring(
        L, QCoreApplication::translate("directions", "out", "Entering this direction will move the player in the game")
               .toUtf8()
               .constData());
    lua_setfield(L, -2, "out");
    lua_pushstring(
        L, QCoreApplication::translate("directions", "o", "Entering this direction will move the player in the game")
               .toUtf8()
               .constData());
    lua_setfield(L, -2, "o");
    lua_pushstring(
        L, QCoreApplication::translate("directions", "up", "Entering this direction will move the player in the game")
               .toUtf8()
               .constData());
    lua_setfield(L, -2, "up");
    lua_pushstring(
        L, QCoreApplication::translate("directions", "u", "Entering this direction will move the player in the game")
               .toUtf8()
               .constData());
    lua_setfield(L, -2, "u");
    lua_pushstring(
        L, QCoreApplication::translate("directions", "down", "Entering this direction will move the player in the game")
               .toUtf8()
               .constData());
    lua_setfield(L, -2, "down");
    lua_pushstring(
        L, QCoreApplication::translate("directions", "d", "Entering this direction will move the player in the game")
               .toUtf8()
               .constData());
    lua_setfield(L, -2, "d");
...
{
    Q_ASSERT_X(!pIndenterState, "TLuaInterpreter::initIndenterGlobals()",
               "Indenter state is already initialized - re-initializing it is very expensive!");
    ...
    luaL_dostring(pIndenterState.get(),
                  QStringLiteral("package.path = '" LUA_DEFAULT_PATH
                                 "/?.lua;%1/?.lua;%1/../3rdparty/?.lua;%1/../../3rdparty/?.lua;' .. package.path")
                      .arg(QCoreApplication::applicationDirPath())
                      .toUtf8()
                      .constData());
    ...
    // if using LuaJIT, adjust the cpath to look in /usr/lib as well - it doesn't by default
    luaL_dostring(pIndenterState.get(), "if jit then package.cpath = package.cpath .. "
                                        "';/usr/lib/lua/5.1/?.so;/usr/lib/x86_64-linux-gnu/lua/5.1/?.so' end");
    ...
    luaL_dostring(
        pIndenterState.get(),
        QStringLiteral(
            "package.path = [[%1\\?.lua;%2\\..\\3rdparty\\?.lua;%2\\..\\..\\3rdparty\\?.lua;]] .. package.path")
...
void TLuaInterpreter::loadGlobal()
{
    ...
    for (const auto &pathFileName : qAsConst(mPossiblePaths))
    {
        ...
        {
            failedMessages << tr("%1 (isn't a file or symlink to a file)",
                                 "This is not a file or a symbolic link to a file")
                                  .arg(pathFileName);
            continue;
        }
        ...
        {
            failedMessages << tr("%1 (isn't a readable file or symlink to a readable file)",
                                 "This is not a file or a symbolic link to a file")
                                  .arg(pathFileName);
            continue;
        }
        ...
        Q_ASSERT_X(!pathFileName.isEmpty(), "TLuaInterpreter::loadGlobal()",
                   "trying to call QFileInfo(path).absolutePath() when path is empty");
        luaL_dostring(
            pGlobalLua,
            QStringLiteral("luaGlobalPath = \"%1\"").arg(QFileInfo(pathFileName).absolutePath()).toUtf8().constData());
        ...
        {
            failedMessages << tr("%1 (couldn't read file)",
        ...
        {
            qWarning() << "TLuaInterpreter::loadGlobal() loading " << pathFileName
                       << " failed: " << lua_tostring(pGlobalLua, -1);
            failedMessages << QStringLiteral("%1 (%2)").arg(pathFileName, lua_tostring(pGlobalLua, -1));
        }
    }

    mpHost->postMessage(tr("[ ERROR ] - Couldn't find, load and successfully run LuaGlobal.lua - your Mudlet is "
                           "broken!\nTried these locations:\n%1")
                            .arg(failedMessages.join(QChar::LineFeed)));
}
...
// No documentation available in wiki - internal function
QPair<int, QString> TLuaInterpreter::createPermScript(const QString &name, const QString &parent,
...
QPair<int, QString> TLuaInterpreter::setScriptCode(QString &name, const QString &luaCode, int pos)
{
    ...
    {
        return qMakePair(
            -1, QStringLiteral("script \"%1\" at position \"%2\" not found").arg(name).arg(++pos)); // script not found
    }
    ...
    if (!pS->setScript(luaCode))
    {
        ...
        return qMakePair(-1, QStringLiteral("unable to compile \"%1\" at position \"%2\", reason: %3")
                                 .arg(luaCode)
                                 .arg(++pos)
                                 .arg(errMsg));
    }
...
// No documentation available in wiki - internal function
QPair<int, QString> TLuaInterpreter::startPermTimer(const QString &name, const QString &parent, double timeout,
...
// No documentation available in wiki - internal function
int TLuaInterpreter::startPermAlias(const QString &name, const QString &parent, const QString &regex,
                                    const QString &function)
{
    TAlias *pT;
...
// No documentation available in wiki - internal function
int TLuaInterpreter::startPermRegexTrigger(const QString &name, const QString &parent, QStringList &regexList,
                                           const QString &function)
{
    TTrigger *pT;
    QList<int> propertyList;
...
// No documentation available in wiki - internal function
int TLuaInterpreter::startPermBeginOfLineStringTrigger(const QString &name, const QString &parent,
                                                       QStringList &regexList, const QString &function)
{
    TTrigger *pT;
    QList<int> propertyList;
    for (int i = 0; i < regexList.size(); i++)
...
// No documentation available in wiki - internal function
int TLuaInterpreter::startPermSubstringTrigger(const QString &name, const QString &parent, const QStringList &regexList,
                                               const QString &function)
{
    TTrigger *pT;
    QList<int> propertyList;
...
int TLuaInterpreter::getColumnCount(lua_State *L)
{
    ...
    {
        lua_pushfstring(L, "getColumnCount: bad argument #1 type (window name as string expected, got %s)",
                        luaL_typename(L, 1));
        lua_error(L);
        return 1;
    }
...
int TLuaInterpreter::getRowCount(lua_State *L)
{
    ...
    {
        lua_pushfstring(L, "getRowCount: bad argument #1 type (window name as string expected, got %s)",
                        luaL_typename(L, 1));
        lua_error(L);
        return 1;
    }
...
int TLuaInterpreter::enableClickthrough(lua_State *L)
{
    ...
    if (n == 1)
    {
        if (!lua_isstring(L, 1))
        {
            lua_pushfstring(L, "enableClickthrough: bad argument #1 type (window name as string expected, got %s!)",
                            luaL_typename(L, 1));
            lua_error(L);
            return 1;
        }
...
int TLuaInterpreter::disableClickthrough(lua_State *L)
{
    ...
    if (n == 1)
    {
        if (!lua_isstring(L, 1))
        {
            lua_pushfstring(L, "disableClickthrough: bad argument #1 type (window name as string expected, got %s!)",
                            luaL_typename(L, 1));
            lua_error(L);
            return 1;
        }
...
int TLuaInterpreter::addWordToDictionary(lua_State *L)
{
    ...
    if (!lua_isstring(L, 1))
    {
        lua_pushfstring(L, "addWordToDictionary: bad argument #1 type (word as string expected, got %s!)",
                        luaL_typename(L, 1));
        return lua_error(L);
    }
    else
...
int TLuaInterpreter::removeWordFromDictionary(lua_State *L)
{
    ...
    if (!lua_isstring(L, 1))
    {
        lua_pushfstring(L, "removeWordFromDictionary: bad argument #1 type (word as string expected, got %s!)",
                        luaL_typename(L, 1));
        return lua_error(L);
    }
    else
...
int TLuaInterpreter::spellCheckWord(lua_State *L)
{
    ...
    if (!lua_isstring(L, 1))
    {
        lua_pushfstring(L, "spellCheckWord: bad argument #1 type (word as string expected, got %s!)",
                        luaL_typename(L, 1));
        return lua_error(L);
    }
    else
    ...
    if (lua_gettop(L) > 1)
    {
        ...
        {
            lua_pushfstring(L,
                            "spellSuggestWord: bad argument #2 type (check profile dictionary as boolean is optional "
                            "{use 'false' or omit to check against system dictionary}, got %s!)",
                            luaL_typename(L, 2));
            return lua_error(L);
        }
        else
    ...
    else
    {
        ...
        {
            lua_pushnil(L);
            lua_pushstring(L, "no main dictionaries found: Mudlet has not been able to find any dictionary files to "
                              "use so is unable to check your word");
            return 2;
        }

        encodedText = host.mpConsole->getHunspellCodec_system()->fromUnicode(text);
    }
    // CHECKME: Is there any danger of contention here - do we need to get mudlet::mDictionaryReadWriteLock locked for
    // reading if we are accessing the shared user dictionary?
...
int TLuaInterpreter::spellSuggestWord(lua_State *L)
{
    ...
    if (!lua_isstring(L, 1))
    {
        lua_pushfstring(L, "spellSuggestWord: bad argument #1 type (word as string expected, got %s!)",
                        luaL_typename(L, 1));
        return lua_error(L);
    }
    else
    ...
    else
    {
        ...
        if (!handle)
        {
            lua_pushnil(L);
            lua_pushstring(L, "no main dictionaries found: Mudlet has not been able to find any dictionary files to "
                              "use so is unable to make suggestions for your word");
            return 2;
        }
