...
class TTrigger : public Tree<TTrigger>
{
  ...
  public:
    ...
    TTrigger(const QString &name, const QStringList &regexList, const QList<int> &regexPropertyList, bool isMultiline,
             Host *pHost); // throws exception ExObjNoCreate
    ...
    void compileAll();
    void setCommand(const QString &b)
    {
        mCommand = b;
    }
    QString getName()
    ...
    QStringList &getRegexCodeList()
    {
        return mRegexCodeList;
    }
    QList<int> getRegexCodePropertyList()
    {
        return mRegexCodePropertyList;
    }
    ...
    void setColorizerFgColor(const QColor &c)
    {
        mFgColor = c;
    }
    void setColorizerBgColor(const QColor &c)
    {
        mBgColor = c;
    }
    bool isColorizerTrigger() const
    {
        return mIsColorizerTrigger;
    }
    void setIsColorizerTrigger(const bool b)
    {
        mIsColorizerTrigger = b;
    }
    void compile();
    void execute();
    bool isFilterChain();
    ...
    bool isLineTrigger()
    {
        return mIsLineTrigger;
    }
    void setIsLineTrigger(bool b)
    {
        mIsLineTrigger = b;
    }
    void setStartOfLineDelta(int b)
    {
        mStartOfLineDelta = b;
    }
    void setLineDelta(int b)
    {
        mLineDelta = b;
    }
    void setTriggerType(int b)
    {
        mTriggerType = b;
    }
    ...
    bool match_begin_of_line_substring(const QString &toMatch, const QString &regex, int regexNumber,
                                       int posOffset = 0);
    ...
    void setConditionLineDelta(int delta)
    {
        mConditionLineDelta = delta;
    }
    int getConditionLineDelta()
    {
        return mConditionLineDelta;
    }
